...
// checks if the AeAssetNegotiationUpserted type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AeAssetNegotiationUpserted{}

// AeAssetNegotiationUpserted Notification that a service order has been placed
type AeAssetNegotiationUpserted struct {
	Detail AeAssetNegotiationUpsertedDetail `json:"detail"`
	// Optional version
...
type _AeAssetNegotiationUpserted AeAssetNegotiationUpserted
...
func NewAeAssetNegotiationUpserted(detail AeAssetNegotiationUpsertedDetail, detailType string, id string, source string) *AeAssetNegotiationUpserted {
	this := AeAssetNegotiationUpserted{}
...
func (o *AeAssetNegotiationUpserted) GetDetail() AeAssetNegotiationUpsertedDetail {
	if o == nil {
		var ret AeAssetNegotiationUpsertedDetail
		return ret
	}
...
func (o AeAssetNegotiationUpserted) MarshalJSON() ([]byte, error) {
...
func (o AeAssetNegotiationUpserted) ToMap() (map[string]interface{}, error) {
...
func (o *AeAssetNegotiationUpserted) UnmarshalJSON(data []byte) (err error) {
	...
	varAeAssetNegotiationUpserted := _AeAssetNegotiationUpserted{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAeAssetNegotiationUpserted)

	if err != nil {
		return err
	}

	*o = AeAssetNegotiationUpserted(varAeAssetNegotiationUpserted)

	return err
}

type NullableAeAssetNegotiationUpserted struct {
	value *AeAssetNegotiationUpserted
	isSet bool
}

func (v NullableAeAssetNegotiationUpserted) Get() *AeAssetNegotiationUpserted {
	return v.value
}

func (v *NullableAeAssetNegotiationUpserted) Set(val *AeAssetNegotiationUpserted) {
	v.value = val
	v.isSet = true
}

func (v NullableAeAssetNegotiationUpserted) IsSet() bool {
	return v.isSet
}

func (v *NullableAeAssetNegotiationUpserted) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAeAssetNegotiationUpserted(val *AeAssetNegotiationUpserted) *NullableAeAssetNegotiationUpserted {
	return &NullableAeAssetNegotiationUpserted{value: val, isSet: true}
}

func (v NullableAeAssetNegotiationUpserted) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAeAssetNegotiationUpserted) UnmarshalJSON(src []byte) error {
	v.isSet = true
