...
// checks if the AeServiceOrderUpdated type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AeServiceOrderUpdated{}

// AeServiceOrderUpdated Notification that a service order has been placed
type AeServiceOrderUpdated struct {
	Detail AeServiceOrderUpdatedDetail `json:"detail"`
...
type _AeServiceOrderUpdated AeServiceOrderUpdated
...
func (o *AeServiceOrderUpdated) GetDetail() AeServiceOrderUpdatedDetail {
	if o == nil {
		var ret AeServiceOrderUpdatedDetail
		return ret
	}
...
func (o AeServiceOrderUpdated) MarshalJSON() ([]byte, error) {
...
func (o AeServiceOrderUpdated) ToMap() (map[string]interface{}, error) {
...
func (o *AeServiceOrderUpdated) UnmarshalJSON(data []byte) (err error) {
	...
	varAeServiceOrderUpdated := _AeServiceOrderUpdated{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAeServiceOrderUpdated)

	if err != nil {
		return err
	}

	*o = AeServiceOrderUpdated(varAeServiceOrderUpdated)

	return err
}

type NullableAeServiceOrderUpdated struct {
	value *AeServiceOrderUpdated
	isSet bool
}

func (v NullableAeServiceOrderUpdated) Get() *AeServiceOrderUpdated {
	return v.value
}

func (v *NullableAeServiceOrderUpdated) Set(val *AeServiceOrderUpdated) {
	v.value = val
	v.isSet = true
}

func (v NullableAeServiceOrderUpdated) IsSet() bool {
	return v.isSet
}

func (v *NullableAeServiceOrderUpdated) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAeServiceOrderUpdated(val *AeServiceOrderUpdated) *NullableAeServiceOrderUpdated {
	return &NullableAeServiceOrderUpdated{value: val, isSet: true}
}

func (v NullableAeServiceOrderUpdated) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAeServiceOrderUpdated) UnmarshalJSON(src []byte) error {
	v.isSet = true
