...
// checks if the AeAssetLabelRequested type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AeAssetLabelRequested{}

// AeAssetLabelRequested Notification that a service order has been placed
type AeAssetLabelRequested struct {
	Detail AeAssetLabelRequestedDetail `json:"detail"`
...
type _AeAssetLabelRequested AeAssetLabelRequested
...
func (o *AeAssetLabelRequested) GetDetail() AeAssetLabelRequestedDetail {
	if o == nil {
		var ret AeAssetLabelRequestedDetail
		return ret
	}
...
func (o AeAssetLabelRequested) MarshalJSON() ([]byte, error) {
...
func (o AeAssetLabelRequested) ToMap() (map[string]interface{}, error) {
...
func (o *AeAssetLabelRequested) UnmarshalJSON(data []byte) (err error) {
	...
	varAeAssetLabelRequested := _AeAssetLabelRequested{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAeAssetLabelRequested)

	if err != nil {
		return err
	}

	*o = AeAssetLabelRequested(varAeAssetLabelRequested)

	return err
}

type NullableAeAssetLabelRequested struct {
	value *AeAssetLabelRequested
	isSet bool
}

func (v NullableAeAssetLabelRequested) Get() *AeAssetLabelRequested {
	return v.value
}

func (v *NullableAeAssetLabelRequested) Set(val *AeAssetLabelRequested) {
	v.value = val
	v.isSet = true
}

func (v NullableAeAssetLabelRequested) IsSet() bool {
	return v.isSet
}

func (v *NullableAeAssetLabelRequested) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAeAssetLabelRequested(val *AeAssetLabelRequested) *NullableAeAssetLabelRequested {
	return &NullableAeAssetLabelRequested{value: val, isSet: true}
}

func (v NullableAeAssetLabelRequested) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAeAssetLabelRequested) UnmarshalJSON(src []byte) error {
	v.isSet = true
