...
// checks if the AeAccountPaymentSourceRemovedAms type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AeAccountPaymentSourceRemovedAms{}

// AeAccountPaymentSourceRemovedAms Notification that a service order has been placed
type AeAccountPaymentSourceRemovedAms struct {
	Detail AeAccountPaymentSourceRemovedAmsDetail `json:"detail"`
	// Optional version
...
type _AeAccountPaymentSourceRemovedAms AeAccountPaymentSourceRemovedAms
...
func NewAeAccountPaymentSourceRemovedAms(detail AeAccountPaymentSourceRemovedAmsDetail, detailType string, id string, source string) *AeAccountPaymentSourceRemovedAms {
	this := AeAccountPaymentSourceRemovedAms{}
...
func (o *AeAccountPaymentSourceRemovedAms) GetDetail() AeAccountPaymentSourceRemovedAmsDetail {
	if o == nil {
		var ret AeAccountPaymentSourceRemovedAmsDetail
		return ret
	}
...
func (o AeAccountPaymentSourceRemovedAms) MarshalJSON() ([]byte, error) {
...
func (o AeAccountPaymentSourceRemovedAms) ToMap() (map[string]interface{}, error) {
...
func (o *AeAccountPaymentSourceRemovedAms) UnmarshalJSON(data []byte) (err error) {
	...
	varAeAccountPaymentSourceRemovedAms := _AeAccountPaymentSourceRemovedAms{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAeAccountPaymentSourceRemovedAms)

	if err != nil {
		return err
	}

	*o = AeAccountPaymentSourceRemovedAms(varAeAccountPaymentSourceRemovedAms)

	return err
}

type NullableAeAccountPaymentSourceRemovedAms struct {
	value *AeAccountPaymentSourceRemovedAms
	isSet bool
}

func (v NullableAeAccountPaymentSourceRemovedAms) Get() *AeAccountPaymentSourceRemovedAms {
	return v.value
}

func (v *NullableAeAccountPaymentSourceRemovedAms) Set(val *AeAccountPaymentSourceRemovedAms) {
	v.value = val
	v.isSet = true
}

func (v NullableAeAccountPaymentSourceRemovedAms) IsSet() bool {
	return v.isSet
}

func (v *NullableAeAccountPaymentSourceRemovedAms) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAeAccountPaymentSourceRemovedAms(val *AeAccountPaymentSourceRemovedAms) *NullableAeAccountPaymentSourceRemovedAms {
	return &NullableAeAccountPaymentSourceRemovedAms{value: val, isSet: true}
}

func (v NullableAeAccountPaymentSourceRemovedAms) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAeAccountPaymentSourceRemovedAms) UnmarshalJSON(src []byte) error {
	v.isSet = true
