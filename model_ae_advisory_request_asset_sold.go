...
// checks if the AeAdvisoryRequestAssetSold type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AeAdvisoryRequestAssetSold{}

// AeAdvisoryRequestAssetSold Notification that a service order has been placed
type AeAdvisoryRequestAssetSold struct {
	Detail AeAdvisoryRequestAssetSoldDetail `json:"detail"`
...
type _AeAdvisoryRequestAssetSold AeAdvisoryRequestAssetSold
...
func NewAeAdvisoryRequestAssetSold(detail AeAdvisoryRequestAssetSoldDetail, detailType string, id string, source string) *AeAdvisoryRequestAssetSold {
	this := AeAdvisoryRequestAssetSold{}
...
func (o *AeAdvisoryRequestAssetSold) GetDetail() AeAdvisoryRequestAssetSoldDetail {
	if o == nil {
		var ret AeAdvisoryRequestAssetSoldDetail
		return ret
	}
...
func (o AeAdvisoryRequestAssetSold) MarshalJSON() ([]byte, error) {
...
func (o AeAdvisoryRequestAssetSold) ToMap() (map[string]interface{}, error) {
...
func (o *AeAdvisoryRequestAssetSold) UnmarshalJSON(data []byte) (err error) {
	...
	varAeAdvisoryRequestAssetSold := _AeAdvisoryRequestAssetSold{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAeAdvisoryRequestAssetSold)

	if err != nil {
		return err
	}

	*o = AeAdvisoryRequestAssetSold(varAeAdvisoryRequestAssetSold)

	return err
}

type NullableAeAdvisoryRequestAssetSold struct {
	value *AeAdvisoryRequestAssetSold
	isSet bool
}

func (v NullableAeAdvisoryRequestAssetSold) Get() *AeAdvisoryRequestAssetSold {
	return v.value
}

func (v *NullableAeAdvisoryRequestAssetSold) Set(val *AeAdvisoryRequestAssetSold) {
	v.value = val
	v.isSet = true
}

func (v NullableAeAdvisoryRequestAssetSold) IsSet() bool {
	return v.isSet
}

func (v *NullableAeAdvisoryRequestAssetSold) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAeAdvisoryRequestAssetSold(val *AeAdvisoryRequestAssetSold) *NullableAeAdvisoryRequestAssetSold {
	return &NullableAeAdvisoryRequestAssetSold{value: val, isSet: true}
}

func (v NullableAeAdvisoryRequestAssetSold) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAeAdvisoryRequestAssetSold) UnmarshalJSON(src []byte) error {
	v.isSet = true
