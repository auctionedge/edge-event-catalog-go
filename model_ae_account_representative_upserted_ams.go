...
// checks if the AeAccountRepresentativeUpsertedAms type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AeAccountRepresentativeUpsertedAms{}

// AeAccountRepresentativeUpsertedAms Notification that a service order has been placed
type AeAccountRepresentativeUpsertedAms struct {
	Detail AeAccountRepresentativeUpsertedAmsDetail `json:"detail"`
	// Optional version
...
type _AeAccountRepresentativeUpsertedAms AeAccountRepresentativeUpsertedAms
...
func NewAeAccountRepresentativeUpsertedAms(detail AeAccountRepresentativeUpsertedAmsDetail, detailType string, id string, source string) *AeAccountRepresentativeUpsertedAms {
	this := AeAccountRepresentativeUpsertedAms{}
...
func (o *AeAccountRepresentativeUpsertedAms) GetDetail() AeAccountRepresentativeUpsertedAmsDetail {
	if o == nil {
		var ret AeAccountRepresentativeUpsertedAmsDetail
		return ret
	}
...
func (o AeAccountRepresentativeUpsertedAms) MarshalJSON() ([]byte, error) {
...
func (o AeAccountRepresentativeUpsertedAms) ToMap() (map[string]interface{}, error) {
...
func (o *AeAccountRepresentativeUpsertedAms) UnmarshalJSON(data []byte) (err error) {
	...
	varAeAccountRepresentativeUpsertedAms := _AeAccountRepresentativeUpsertedAms{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAeAccountRepresentativeUpsertedAms)

	if err != nil {
		return err
	}

	*o = AeAccountRepresentativeUpsertedAms(varAeAccountRepresentativeUpsertedAms)

	return err
}

type NullableAeAccountRepresentativeUpsertedAms struct {
	value *AeAccountRepresentativeUpsertedAms
	isSet bool
}

func (v NullableAeAccountRepresentativeUpsertedAms) Get() *AeAccountRepresentativeUpsertedAms {
	return v.value
}

func (v *NullableAeAccountRepresentativeUpsertedAms) Set(val *AeAccountRepresentativeUpsertedAms) {
	v.value = val
	v.isSet = true
}

func (v NullableAeAccountRepresentativeUpsertedAms) IsSet() bool {
	return v.isSet
}

func (v *NullableAeAccountRepresentativeUpsertedAms) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAeAccountRepresentativeUpsertedAms(val *AeAccountRepresentativeUpsertedAms) *NullableAeAccountRepresentativeUpsertedAms {
	return &NullableAeAccountRepresentativeUpsertedAms{value: val, isSet: true}
}

func (v NullableAeAccountRepresentativeUpsertedAms) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAeAccountRepresentativeUpsertedAms) UnmarshalJSON(src []byte) error {
	v.isSet = true
