...
// checks if the AeAccountRepresentativePayerAuthorized type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AeAccountRepresentativePayerAuthorized{}

// AeAccountRepresentativePayerAuthorized Notification that a service order has been placed
type AeAccountRepresentativePayerAuthorized struct {
	Detail AeAccountRepresentativePayerAuthorizedDetail `json:"detail"`
	// Optional version
...
type _AeAccountRepresentativePayerAuthorized AeAccountRepresentativePayerAuthorized
...
func NewAeAccountRepresentativePayerAuthorized(detail AeAccountRepresentativePayerAuthorizedDetail, detailType string, id string, source string) *AeAccountRepresentativePayerAuthorized {
	this := AeAccountRepresentativePayerAuthorized{}
...
func (o *AeAccountRepresentativePayerAuthorized) GetDetail() AeAccountRepresentativePayerAuthorizedDetail {
	if o == nil {
		var ret AeAccountRepresentativePayerAuthorizedDetail
		return ret
	}
...
func (o AeAccountRepresentativePayerAuthorized) MarshalJSON() ([]byte, error) {
...
func (o AeAccountRepresentativePayerAuthorized) ToMap() (map[string]interface{}, error) {
...
func (o *AeAccountRepresentativePayerAuthorized) UnmarshalJSON(data []byte) (err error) {
	...
	varAeAccountRepresentativePayerAuthorized := _AeAccountRepresentativePayerAuthorized{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAeAccountRepresentativePayerAuthorized)

	if err != nil {
		return err
	}

	*o = AeAccountRepresentativePayerAuthorized(varAeAccountRepresentativePayerAuthorized)

	return err
}

type NullableAeAccountRepresentativePayerAuthorized struct {
	value *AeAccountRepresentativePayerAuthorized
	isSet bool
}

func (v NullableAeAccountRepresentativePayerAuthorized) Get() *AeAccountRepresentativePayerAuthorized {
	return v.value
}

func (v *NullableAeAccountRepresentativePayerAuthorized) Set(val *AeAccountRepresentativePayerAuthorized) {
	v.value = val
	v.isSet = true
}

func (v NullableAeAccountRepresentativePayerAuthorized) IsSet() bool {
	return v.isSet
}

func (v *NullableAeAccountRepresentativePayerAuthorized) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAeAccountRepresentativePayerAuthorized(val *AeAccountRepresentativePayerAuthorized) *NullableAeAccountRepresentativePayerAuthorized {
	return &NullableAeAccountRepresentativePayerAuthorized{value: val, isSet: true}
}

func (v NullableAeAccountRepresentativePayerAuthorized) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAeAccountRepresentativePayerAuthorized) UnmarshalJSON(src []byte) error {
	v.isSet = true
