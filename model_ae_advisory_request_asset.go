...
// checks if the AeAdvisoryRequestAsset type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AeAdvisoryRequestAsset{}

// AeAdvisoryRequestAsset Notification that a service order has been placed
type AeAdvisoryRequestAsset struct {
	Detail AeAdvisoryRequestAssetDetail `json:"detail"`
	// Optional version
...
type _AeAdvisoryRequestAsset AeAdvisoryRequestAsset
...
func (o *AeAdvisoryRequestAsset) GetDetail() AeAdvisoryRequestAssetDetail {
	if o == nil {
		var ret AeAdvisoryRequestAssetDetail
		return ret
	}
...
func (o AeAdvisoryRequestAsset) MarshalJSON() ([]byte, error) {
...
func (o AeAdvisoryRequestAsset) ToMap() (map[string]interface{}, error) {
...
func (o *AeAdvisoryRequestAsset) UnmarshalJSON(data []byte) (err error) {
	...
	varAeAdvisoryRequestAsset := _AeAdvisoryRequestAsset{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAeAdvisoryRequestAsset)

	if err != nil {
		return err
	}

	*o = AeAdvisoryRequestAsset(varAeAdvisoryRequestAsset)

	return err
}

type NullableAeAdvisoryRequestAsset struct {
	value *AeAdvisoryRequestAsset
	isSet bool
}

func (v NullableAeAdvisoryRequestAsset) Get() *AeAdvisoryRequestAsset {
	return v.value
}

func (v *NullableAeAdvisoryRequestAsset) Set(val *AeAdvisoryRequestAsset) {
	v.value = val
	v.isSet = true
}

func (v NullableAeAdvisoryRequestAsset) IsSet() bool {
	return v.isSet
}

func (v *NullableAeAdvisoryRequestAsset) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAeAdvisoryRequestAsset(val *AeAdvisoryRequestAsset) *NullableAeAdvisoryRequestAsset {
	return &NullableAeAdvisoryRequestAsset{value: val, isSet: true}
}

func (v NullableAeAdvisoryRequestAsset) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAeAdvisoryRequestAsset) UnmarshalJSON(src []byte) error {
	v.isSet = true
