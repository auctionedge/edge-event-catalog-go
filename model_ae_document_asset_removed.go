...
// checks if the AeDocumentAssetRemoved type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AeDocumentAssetRemoved{}

// AeDocumentAssetRemoved Notification that a service order has been placed
type AeDocumentAssetRemoved struct {
	Detail AeDocumentAssetRemovedDetail `json:"detail"`
...
type _AeDocumentAssetRemoved AeDocumentAssetRemoved
...
func (o *AeDocumentAssetRemoved) GetDetail() AeDocumentAssetRemovedDetail {
	if o == nil {
		var ret AeDocumentAssetRemovedDetail
		return ret
	}
...
func (o AeDocumentAssetRemoved) MarshalJSON() ([]byte, error) {
...
func (o AeDocumentAssetRemoved) ToMap() (map[string]interface{}, error) {
...
func (o *AeDocumentAssetRemoved) UnmarshalJSON(data []byte) (err error) {
	...
	varAeDocumentAssetRemoved := _AeDocumentAssetRemoved{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAeDocumentAssetRemoved)

	if err != nil {
		return err
	}

	*o = AeDocumentAssetRemoved(varAeDocumentAssetRemoved)

	return err
}

type NullableAeDocumentAssetRemoved struct {
	value *AeDocumentAssetRemoved
	isSet bool
}

func (v NullableAeDocumentAssetRemoved) Get() *AeDocumentAssetRemoved {
	return v.value
}

func (v *NullableAeDocumentAssetRemoved) Set(val *AeDocumentAssetRemoved) {
	v.value = val
	v.isSet = true
}

func (v NullableAeDocumentAssetRemoved) IsSet() bool {
	return v.isSet
}

func (v *NullableAeDocumentAssetRemoved) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAeDocumentAssetRemoved(val *AeDocumentAssetRemoved) *NullableAeDocumentAssetRemoved {
	return &NullableAeDocumentAssetRemoved{value: val, isSet: true}
}

func (v NullableAeDocumentAssetRemoved) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAeDocumentAssetRemoved) UnmarshalJSON(src []byte) error {
	v.isSet = true
