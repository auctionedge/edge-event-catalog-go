...
// checks if the AeAssetNegotiationNoteAdded type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AeAssetNegotiationNoteAdded{}

// AeAssetNegotiationNoteAdded Notification that a service order has been placed
type AeAssetNegotiationNoteAdded struct {
	Detail AeAssetNegotiationNoteAddedDetail `json:"detail"`
...
type _AeAssetNegotiationNoteAdded AeAssetNegotiationNoteAdded
...
func NewAeAssetNegotiationNoteAdded(detail AeAssetNegotiationNoteAddedDetail, detailType string, id string, source string) *AeAssetNegotiationNoteAdded {
	this := AeAssetNegotiationNoteAdded{}
...
func (o *AeAssetNegotiationNoteAdded) GetDetail() AeAssetNegotiationNoteAddedDetail {
	if o == nil {
		var ret AeAssetNegotiationNoteAddedDetail
		return ret
	}
...
func (o AeAssetNegotiationNoteAdded) MarshalJSON() ([]byte, error) {
...
func (o AeAssetNegotiationNoteAdded) ToMap() (map[string]interface{}, error) {
...
func (o *AeAssetNegotiationNoteAdded) UnmarshalJSON(data []byte) (err error) {
	...
	varAeAssetNegotiationNoteAdded := _AeAssetNegotiationNoteAdded{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAeAssetNegotiationNoteAdded)

	if err != nil {
		return err
	}

	*o = AeAssetNegotiationNoteAdded(varAeAssetNegotiationNoteAdded)

	return err
}

type NullableAeAssetNegotiationNoteAdded struct {
	value *AeAssetNegotiationNoteAdded
	isSet bool
}

func (v NullableAeAssetNegotiationNoteAdded) Get() *AeAssetNegotiationNoteAdded {
	return v.value
}

func (v *NullableAeAssetNegotiationNoteAdded) Set(val *AeAssetNegotiationNoteAdded) {
	v.value = val
	v.isSet = true
}

func (v NullableAeAssetNegotiationNoteAdded) IsSet() bool {
	return v.isSet
}

func (v *NullableAeAssetNegotiationNoteAdded) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAeAssetNegotiationNoteAdded(val *AeAssetNegotiationNoteAdded) *NullableAeAssetNegotiationNoteAdded {
	return &NullableAeAssetNegotiationNoteAdded{value: val, isSet: true}
}

func (v NullableAeAssetNegotiationNoteAdded) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAeAssetNegotiationNoteAdded) UnmarshalJSON(src []byte) error {
	v.isSet = true
