...
// checks if the AeAssetGatepassBuyerReleasable type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AeAssetGatepassBuyerReleasable{}

// AeAssetGatepassBuyerReleasable Notification that a service order has been placed
type AeAssetGatepassBuyerReleasable struct {
	Detail AeAssetGatepassBuyerReleasableDetail `json:"detail"`
	// Optional version
...
type _AeAssetGatepassBuyerReleasable AeAssetGatepassBuyerReleasable
...
func NewAeAssetGatepassBuyerReleasable(detail AeAssetGatepassBuyerReleasableDetail, detailType string, id string, source string) *AeAssetGatepassBuyerReleasable {
	this := AeAssetGatepassBuyerReleasable{}
...
func (o *AeAssetGatepassBuyerReleasable) GetDetail() AeAssetGatepassBuyerReleasableDetail {
	if o == nil {
		var ret AeAssetGatepassBuyerReleasableDetail
		return ret
	}
...
func (o AeAssetGatepassBuyerReleasable) MarshalJSON() ([]byte, error) {
...
func (o AeAssetGatepassBuyerReleasable) ToMap() (map[string]interface{}, error) {
...
func (o *AeAssetGatepassBuyerReleasable) UnmarshalJSON(data []byte) (err error) {
	...
	varAeAssetGatepassBuyerReleasable := _AeAssetGatepassBuyerReleasable{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAeAssetGatepassBuyerReleasable)

	if err != nil {
		return err
	}

	*o = AeAssetGatepassBuyerReleasable(varAeAssetGatepassBuyerReleasable)

	return err
}

type NullableAeAssetGatepassBuyerReleasable struct {
	value *AeAssetGatepassBuyerReleasable
	isSet bool
}

func (v NullableAeAssetGatepassBuyerReleasable) Get() *AeAssetGatepassBuyerReleasable {
	return v.value
}

func (v *NullableAeAssetGatepassBuyerReleasable) Set(val *AeAssetGatepassBuyerReleasable) {
	v.value = val
	v.isSet = true
}

func (v NullableAeAssetGatepassBuyerReleasable) IsSet() bool {
	return v.isSet
}

func (v *NullableAeAssetGatepassBuyerReleasable) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAeAssetGatepassBuyerReleasable(val *AeAssetGatepassBuyerReleasable) *NullableAeAssetGatepassBuyerReleasable {
	return &NullableAeAssetGatepassBuyerReleasable{value: val, isSet: true}
}

func (v NullableAeAssetGatepassBuyerReleasable) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAeAssetGatepassBuyerReleasable) UnmarshalJSON(src []byte) error {
	v.isSet = true
