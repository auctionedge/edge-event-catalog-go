...
// checks if the AeServiceOrderPlaced type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AeServiceOrderPlaced{}

// AeServiceOrderPlaced Notification that a service order has been placed
type AeServiceOrderPlaced struct {
	Detail AeServiceOrderPlacedDetail `json:"detail"`
...
type _AeServiceOrderPlaced AeServiceOrderPlaced
...
func (o *AeServiceOrderPlaced) GetDetail() AeServiceOrderPlacedDetail {
	if o == nil {
		var ret AeServiceOrderPlacedDetail
		return ret
	}
...
func (o AeServiceOrderPlaced) MarshalJSON() ([]byte, error) {
...
func (o AeServiceOrderPlaced) ToMap() (map[string]interface{}, error) {
...
func (o *AeServiceOrderPlaced) UnmarshalJSON(data []byte) (err error) {
	...
	varAeServiceOrderPlaced := _AeServiceOrderPlaced{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAeServiceOrderPlaced)

	if err != nil {
		return err
	}

	*o = AeServiceOrderPlaced(varAeServiceOrderPlaced)

	return err
}

type NullableAeServiceOrderPlaced struct {
	value *AeServiceOrderPlaced
	isSet bool
}

func (v NullableAeServiceOrderPlaced) Get() *AeServiceOrderPlaced {
	return v.value
}

func (v *NullableAeServiceOrderPlaced) Set(val *AeServiceOrderPlaced) {
	v.value = val
	v.isSet = true
}

func (v NullableAeServiceOrderPlaced) IsSet() bool {
	return v.isSet
}

func (v *NullableAeServiceOrderPlaced) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAeServiceOrderPlaced(val *AeServiceOrderPlaced) *NullableAeServiceOrderPlaced {
	return &NullableAeServiceOrderPlaced{value: val, isSet: true}
}

func (v NullableAeServiceOrderPlaced) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAeServiceOrderPlaced) UnmarshalJSON(src []byte) error {
	v.isSet = true
