...
// checks if the AeAmsPaymentVendorUpsert type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AeAmsPaymentVendorUpsert{}

// AeAmsPaymentVendorUpsert Notification that a service order has been placed
type AeAmsPaymentVendorUpsert struct {
	Detail AeAmsPaymentVendorUpsertDetail `json:"detail"`
...
type _AeAmsPaymentVendorUpsert AeAmsPaymentVendorUpsert
...
func (o *AeAmsPaymentVendorUpsert) GetDetail() AeAmsPaymentVendorUpsertDetail {
	if o == nil {
		var ret AeAmsPaymentVendorUpsertDetail
		return ret
	}
...
func (o AeAmsPaymentVendorUpsert) MarshalJSON() ([]byte, error) {
...
func (o AeAmsPaymentVendorUpsert) ToMap() (map[string]interface{}, error) {
...
func (o *AeAmsPaymentVendorUpsert) UnmarshalJSON(data []byte) (err error) {
	...
	varAeAmsPaymentVendorUpsert := _AeAmsPaymentVendorUpsert{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAeAmsPaymentVendorUpsert)

	if err != nil {
		return err
	}

	*o = AeAmsPaymentVendorUpsert(varAeAmsPaymentVendorUpsert)

	return err
}

type NullableAeAmsPaymentVendorUpsert struct {
	value *AeAmsPaymentVendorUpsert
	isSet bool
}

func (v NullableAeAmsPaymentVendorUpsert) Get() *AeAmsPaymentVendorUpsert {
	return v.value
}

func (v *NullableAeAmsPaymentVendorUpsert) Set(val *AeAmsPaymentVendorUpsert) {
	v.value = val
	v.isSet = true
}

func (v NullableAeAmsPaymentVendorUpsert) IsSet() bool {
	return v.isSet
}

func (v *NullableAeAmsPaymentVendorUpsert) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAeAmsPaymentVendorUpsert(val *AeAmsPaymentVendorUpsert) *NullableAeAmsPaymentVendorUpsert {
	return &NullableAeAmsPaymentVendorUpsert{value: val, isSet: true}
}

func (v NullableAeAmsPaymentVendorUpsert) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAeAmsPaymentVendorUpsert) UnmarshalJSON(src []byte) error {
	v.isSet = true
