...
// checks if the AeAssetLabelFailedDetail type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AeAssetLabelFailedDetail{}

// AeAssetLabelFailedDetail Event fired when the label request is unable to be successfully processed
type AeAssetLabelFailedDetail struct {
	...
	Vin string `json:"vin"`
	// Error message when generation was attempted
...
type _AeAssetLabelFailedDetail AeAssetLabelFailedDetail
...
func (o AeAssetLabelFailedDetail) MarshalJSON() ([]byte, error) {
...
func (o AeAssetLabelFailedDetail) ToMap() (map[string]interface{}, error) {
...
func (o *AeAssetLabelFailedDetail) UnmarshalJSON(data []byte) (err error) {
	...
	varAeAssetLabelFailedDetail := _AeAssetLabelFailedDetail{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAeAssetLabelFailedDetail)

	if err != nil {
		return err
	}

	*o = AeAssetLabelFailedDetail(varAeAssetLabelFailedDetail)

	return err
}

type NullableAeAssetLabelFailedDetail struct {
	value *AeAssetLabelFailedDetail
	isSet bool
}

func (v NullableAeAssetLabelFailedDetail) Get() *AeAssetLabelFailedDetail {
	return v.value
}

func (v *NullableAeAssetLabelFailedDetail) Set(val *AeAssetLabelFailedDetail) {
	v.value = val
	v.isSet = true
}

func (v NullableAeAssetLabelFailedDetail) IsSet() bool {
	return v.isSet
}

func (v *NullableAeAssetLabelFailedDetail) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAeAssetLabelFailedDetail(val *AeAssetLabelFailedDetail) *NullableAeAssetLabelFailedDetail {
	return &NullableAeAssetLabelFailedDetail{value: val, isSet: true}
}

func (v NullableAeAssetLabelFailedDetail) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAeAssetLabelFailedDetail) UnmarshalJSON(src []byte) error {
	v.isSet = true
