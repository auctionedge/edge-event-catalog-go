...
// checks if the AeServiceCancelled type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AeServiceCancelled{}

// AeServiceCancelled Notification that a service order has been placed
type AeServiceCancelled struct {
	Detail AeServiceCancelledDetail `json:"detail"`
	// Optional version
...
type _AeServiceCancelled AeServiceCancelled
...
func (o *AeServiceCancelled) GetDetail() AeServiceCancelledDetail {
	if o == nil {
		var ret AeServiceCancelledDetail
		return ret
	}
...
func (o AeServiceCancelled) MarshalJSON() ([]byte, error) {
...
func (o AeServiceCancelled) ToMap() (map[string]interface{}, error) {
...
func (o *AeServiceCancelled) UnmarshalJSON(data []byte) (err error) {
	...
	varAeServiceCancelled := _AeServiceCancelled{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAeServiceCancelled)

	if err != nil {
		return err
	}

	*o = AeServiceCancelled(varAeServiceCancelled)

	return err
}

type NullableAeServiceCancelled struct {
	value *AeServiceCancelled
	isSet bool
}

func (v NullableAeServiceCancelled) Get() *AeServiceCancelled {
	return v.value
}

func (v *NullableAeServiceCancelled) Set(val *AeServiceCancelled) {
	v.value = val
	v.isSet = true
}

func (v NullableAeServiceCancelled) IsSet() bool {
	return v.isSet
}

func (v *NullableAeServiceCancelled) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAeServiceCancelled(val *AeServiceCancelled) *NullableAeServiceCancelled {
	return &NullableAeServiceCancelled{value: val, isSet: true}
}

func (v NullableAeServiceCancelled) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAeServiceCancelled) UnmarshalJSON(src []byte) error {
	v.isSet = true
