...
// checks if the AeAssetLabelGenerated type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AeAssetLabelGenerated{}

// AeAssetLabelGenerated Notification that a service order has been placed
type AeAssetLabelGenerated struct {
	Detail AeAssetLabelGeneratedDetail `json:"detail"`
...
type _AeAssetLabelGenerated AeAssetLabelGenerated
...
func (o *AeAssetLabelGenerated) GetDetail() AeAssetLabelGeneratedDetail {
	if o == nil {
		var ret AeAssetLabelGeneratedDetail
		return ret
	}
...
func (o AeAssetLabelGenerated) MarshalJSON() ([]byte, error) {
...
func (o AeAssetLabelGenerated) ToMap() (map[string]interface{}, error) {
...
func (o *AeAssetLabelGenerated) UnmarshalJSON(data []byte) (err error) {
	...
	varAeAssetLabelGenerated := _AeAssetLabelGenerated{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAeAssetLabelGenerated)

	if err != nil {
		return err
	}

	*o = AeAssetLabelGenerated(varAeAssetLabelGenerated)

	return err
}

type NullableAeAssetLabelGenerated struct {
	value *AeAssetLabelGenerated
	isSet bool
}

func (v NullableAeAssetLabelGenerated) Get() *AeAssetLabelGenerated {
	return v.value
}

func (v *NullableAeAssetLabelGenerated) Set(val *AeAssetLabelGenerated) {
	v.value = val
	v.isSet = true
}

func (v NullableAeAssetLabelGenerated) IsSet() bool {
	return v.isSet
}

func (v *NullableAeAssetLabelGenerated) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAeAssetLabelGenerated(val *AeAssetLabelGenerated) *NullableAeAssetLabelGenerated {
	return &NullableAeAssetLabelGenerated{value: val, isSet: true}
}

func (v NullableAeAssetLabelGenerated) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAeAssetLabelGenerated) UnmarshalJSON(src []byte) error {
	v.isSet = true
