...
// checks if the AeAssetDealChargeRemoved type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AeAssetDealChargeRemoved{}

// AeAssetDealChargeRemoved Notification that a service order has been placed
type AeAssetDealChargeRemoved struct {
	Detail AeAssetDealChargeRemovedDetail `json:"detail"`
	// Optional version
...
type _AeAssetDealChargeRemoved AeAssetDealChargeRemoved
...
func (o *AeAssetDealChargeRemoved) GetDetail() AeAssetDealChargeRemovedDetail {
	if o == nil {
		var ret AeAssetDealChargeRemovedDetail
		return ret
	}
...
func (o AeAssetDealChargeRemoved) MarshalJSON() ([]byte, error) {
...
func (o AeAssetDealChargeRemoved) ToMap() (map[string]interface{}, error) {
...
func (o *AeAssetDealChargeRemoved) UnmarshalJSON(data []byte) (err error) {
	...
	varAeAssetDealChargeRemoved := _AeAssetDealChargeRemoved{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAeAssetDealChargeRemoved)

	if err != nil {
		return err
	}

	*o = AeAssetDealChargeRemoved(varAeAssetDealChargeRemoved)

	return err
}

type NullableAeAssetDealChargeRemoved struct {
	value *AeAssetDealChargeRemoved
	isSet bool
}

func (v NullableAeAssetDealChargeRemoved) Get() *AeAssetDealChargeRemoved {
	return v.value
}

func (v *NullableAeAssetDealChargeRemoved) Set(val *AeAssetDealChargeRemoved) {
	v.value = val
	v.isSet = true
}

func (v NullableAeAssetDealChargeRemoved) IsSet() bool {
	return v.isSet
}

func (v *NullableAeAssetDealChargeRemoved) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAeAssetDealChargeRemoved(val *AeAssetDealChargeRemoved) *NullableAeAssetDealChargeRemoved {
	return &NullableAeAssetDealChargeRemoved{value: val, isSet: true}
}

func (v NullableAeAssetDealChargeRemoved) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAeAssetDealChargeRemoved) UnmarshalJSON(src []byte) error {
	v.isSet = true
