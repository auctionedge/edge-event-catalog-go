...
// checks if the AeServiceOrderRejected type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AeServiceOrderRejected{}
...
type _AeServiceOrderRejected AeServiceOrderRejected
...
func (o *AeServiceOrderRejected) GetDetail() AeServiceOrderRejectedDetail {
	if o == nil {
		var ret AeServiceOrderRejectedDetail
		return ret
	}
...
func (o AeServiceOrderRejected) MarshalJSON() ([]byte, error) {
...
func (o *AeServiceOrderRejected) UnmarshalJSON(data []byte) (err error) {
	...
	varAeServiceOrderRejected := _AeServiceOrderRejected{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAeServiceOrderRejected)

	if err != nil {
		return err
	}

	*o = AeServiceOrderRejected(varAeServiceOrderRejected)

	return err
}

type NullableAeServiceOrderRejected struct {
	value *AeServiceOrderRejected
	isSet bool
}

func (v NullableAeServiceOrderRejected) Get() *AeServiceOrderRejected {
	return v.value
}

func (v *NullableAeServiceOrderRejected) Set(val *AeServiceOrderRejected) {
	v.value = val
	v.isSet = true
}

func (v NullableAeServiceOrderRejected) IsSet() bool {
	return v.isSet
}

func (v *NullableAeServiceOrderRejected) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAeServiceOrderRejected(val *AeServiceOrderRejected) *NullableAeServiceOrderRejected {
	return &NullableAeServiceOrderRejected{value: val, isSet: true}
}

func (v NullableAeServiceOrderRejected) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAeServiceOrderRejected) UnmarshalJSON(src []byte) error {
	v.isSet = true
