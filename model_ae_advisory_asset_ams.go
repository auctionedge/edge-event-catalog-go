...
// checks if the AeAdvisoryAssetAms type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AeAdvisoryAssetAms{}

// AeAdvisoryAssetAms Notification that a service order has been placed
type AeAdvisoryAssetAms struct {
	Detail AeAdvisoryAssetAmsDetail `json:"detail"`
...
type _AeAdvisoryAssetAms AeAdvisoryAssetAms
...
func (o *AeAdvisoryAssetAms) GetDetail() AeAdvisoryAssetAmsDetail {
	if o == nil {
		var ret AeAdvisoryAssetAmsDetail
		return ret
	}
...
func (o AeAdvisoryAssetAms) MarshalJSON() ([]byte, error) {
...
func (o AeAdvisoryAssetAms) ToMap() (map[string]interface{}, error) {
...
func (o *AeAdvisoryAssetAms) UnmarshalJSON(data []byte) (err error) {
	...
	varAeAdvisoryAssetAms := _AeAdvisoryAssetAms{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAeAdvisoryAssetAms)

	if err != nil {
		return err
	}

	*o = AeAdvisoryAssetAms(varAeAdvisoryAssetAms)

	return err
}

type NullableAeAdvisoryAssetAms struct {
	value *AeAdvisoryAssetAms
	isSet bool
}

func (v NullableAeAdvisoryAssetAms) Get() *AeAdvisoryAssetAms {
	return v.value
}

func (v *NullableAeAdvisoryAssetAms) Set(val *AeAdvisoryAssetAms) {
	v.value = val
	v.isSet = true
}

func (v NullableAeAdvisoryAssetAms) IsSet() bool {
	return v.isSet
}

func (v *NullableAeAdvisoryAssetAms) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAeAdvisoryAssetAms(val *AeAdvisoryAssetAms) *NullableAeAdvisoryAssetAms {
	return &NullableAeAdvisoryAssetAms{value: val, isSet: true}
}

func (v NullableAeAdvisoryAssetAms) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAeAdvisoryAssetAms) UnmarshalJSON(src []byte) error {
	v.isSet = true
