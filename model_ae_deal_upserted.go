...
// checks if the AeDealUpserted type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AeDealUpserted{}

// AeDealUpserted Notification that a service order has been placed
type AeDealUpserted struct {
	Detail AeDealUpsertedDetail `json:"detail"`
	// Optional version
...
type _AeDealUpserted AeDealUpserted
...
func (o AeDealUpserted) MarshalJSON() ([]byte, error) {
...
func (o AeDealUpserted) ToMap() (map[string]interface{}, error) {
...
func (o *AeDealUpserted) UnmarshalJSON(data []byte) (err error) {
	...
	varAeDealUpserted := _AeDealUpserted{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAeDealUpserted)

	if err != nil {
		return err
	}

	*o = AeDealUpserted(varAeDealUpserted)

	return err
}

type NullableAeDealUpserted struct {
	value *AeDealUpserted
	isSet bool
}

func (v NullableAeDealUpserted) Get() *AeDealUpserted {
	return v.value
}

func (v *NullableAeDealUpserted) Set(val *AeDealUpserted) {
	v.value = val
	v.isSet = true
}

func (v NullableAeDealUpserted) IsSet() bool {
	return v.isSet
}

func (v *NullableAeDealUpserted) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAeDealUpserted(val *AeDealUpserted) *NullableAeDealUpserted {
	return &NullableAeDealUpserted{value: val, isSet: true}
}

func (v NullableAeDealUpserted) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAeDealUpserted) UnmarshalJSON(src []byte) error {
	v.isSet = true
