...
// checks if the AeAccountPaymentSourceUpsertAms type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AeAccountPaymentSourceUpsertAms{}

// AeAccountPaymentSourceUpsertAms Notification that a service order has been placed
type AeAccountPaymentSourceUpsertAms struct {
	Detail AeAccountPaymentSourceUpsertAmsDetail `json:"detail"`
...
type _AeAccountPaymentSourceUpsertAms AeAccountPaymentSourceUpsertAms
...
func NewAeAccountPaymentSourceUpsertAms(detail AeAccountPaymentSourceUpsertAmsDetail, detailType string, id string, source string) *AeAccountPaymentSourceUpsertAms {
	this := AeAccountPaymentSourceUpsertAms{}
...
func (o *AeAccountPaymentSourceUpsertAms) GetDetail() AeAccountPaymentSourceUpsertAmsDetail {
	if o == nil {
		var ret AeAccountPaymentSourceUpsertAmsDetail
		return ret
	}
...
func (o AeAccountPaymentSourceUpsertAms) MarshalJSON() ([]byte, error) {
...
func (o AeAccountPaymentSourceUpsertAms) ToMap() (map[string]interface{}, error) {
...
func (o *AeAccountPaymentSourceUpsertAms) UnmarshalJSON(data []byte) (err error) {
	...
	varAeAccountPaymentSourceUpsertAms := _AeAccountPaymentSourceUpsertAms{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAeAccountPaymentSourceUpsertAms)

	if err != nil {
		return err
	}

	*o = AeAccountPaymentSourceUpsertAms(varAeAccountPaymentSourceUpsertAms)

	return err
}

type NullableAeAccountPaymentSourceUpsertAms struct {
	value *AeAccountPaymentSourceUpsertAms
	isSet bool
}

func (v NullableAeAccountPaymentSourceUpsertAms) Get() *AeAccountPaymentSourceUpsertAms {
	return v.value
}

func (v *NullableAeAccountPaymentSourceUpsertAms) Set(val *AeAccountPaymentSourceUpsertAms) {
	v.value = val
	v.isSet = true
}

func (v NullableAeAccountPaymentSourceUpsertAms) IsSet() bool {
	return v.isSet
}

func (v *NullableAeAccountPaymentSourceUpsertAms) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAeAccountPaymentSourceUpsertAms(val *AeAccountPaymentSourceUpsertAms) *NullableAeAccountPaymentSourceUpsertAms {
	return &NullableAeAccountPaymentSourceUpsertAms{value: val, isSet: true}
}

func (v NullableAeAccountPaymentSourceUpsertAms) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAeAccountPaymentSourceUpsertAms) UnmarshalJSON(src []byte) error {
	v.isSet = true
