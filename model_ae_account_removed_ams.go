...
// checks if the AeAccountRemovedAms type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AeAccountRemovedAms{}

// AeAccountRemovedAms Notification that a service order has been placed
type AeAccountRemovedAms struct {
	Detail AeAccountRemovedAmsDetail `json:"detail"`
...
type _AeAccountRemovedAms AeAccountRemovedAms
...
func (o *AeAccountRemovedAms) GetDetail() AeAccountRemovedAmsDetail {
	if o == nil {
		var ret AeAccountRemovedAmsDetail
		return ret
	}
...
func (o AeAccountRemovedAms) MarshalJSON() ([]byte, error) {
...
func (o AeAccountRemovedAms) ToMap() (map[string]interface{}, error) {
...
func (o *AeAccountRemovedAms) UnmarshalJSON(data []byte) (err error) {
	...
	varAeAccountRemovedAms := _AeAccountRemovedAms{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAeAccountRemovedAms)

	if err != nil {
		return err
	}

	*o = AeAccountRemovedAms(varAeAccountRemovedAms)

	return err
}

type NullableAeAccountRemovedAms struct {
	value *AeAccountRemovedAms
	isSet bool
}

func (v NullableAeAccountRemovedAms) Get() *AeAccountRemovedAms {
	return v.value
}

func (v *NullableAeAccountRemovedAms) Set(val *AeAccountRemovedAms) {
	v.value = val
	v.isSet = true
}

func (v NullableAeAccountRemovedAms) IsSet() bool {
	return v.isSet
}

func (v *NullableAeAccountRemovedAms) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAeAccountRemovedAms(val *AeAccountRemovedAms) *NullableAeAccountRemovedAms {
	return &NullableAeAccountRemovedAms{value: val, isSet: true}
}

func (v NullableAeAccountRemovedAms) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAeAccountRemovedAms) UnmarshalJSON(src []byte) error {
	v.isSet = true
