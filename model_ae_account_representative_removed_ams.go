...
// checks if the AeAccountRepresentativeRemovedAms type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AeAccountRepresentativeRemovedAms{}

// AeAccountRepresentativeRemovedAms Notification that a service order has been placed
type AeAccountRepresentativeRemovedAms struct {
	Detail AeAccountRepresentativeRemovedAmsDetail `json:"detail"`
	// Optional version
...
type _AeAccountRepresentativeRemovedAms AeAccountRepresentativeRemovedAms
...
func NewAeAccountRepresentativeRemovedAms(detail AeAccountRepresentativeRemovedAmsDetail, detailType string, id string, source string) *AeAccountRepresentativeRemovedAms {
	this := AeAccountRepresentativeRemovedAms{}
...
func (o *AeAccountRepresentativeRemovedAms) GetDetail() AeAccountRepresentativeRemovedAmsDetail {
	if o == nil {
		var ret AeAccountRepresentativeRemovedAmsDetail
		return ret
	}
...
func (o AeAccountRepresentativeRemovedAms) MarshalJSON() ([]byte, error) {
...
func (o AeAccountRepresentativeRemovedAms) ToMap() (map[string]interface{}, error) {
...
func (o *AeAccountRepresentativeRemovedAms) UnmarshalJSON(data []byte) (err error) {
	...
	varAeAccountRepresentativeRemovedAms := _AeAccountRepresentativeRemovedAms{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAeAccountRepresentativeRemovedAms)

	if err != nil {
		return err
	}

	*o = AeAccountRepresentativeRemovedAms(varAeAccountRepresentativeRemovedAms)

	return err
}

type NullableAeAccountRepresentativeRemovedAms struct {
	value *AeAccountRepresentativeRemovedAms
	isSet bool
}

func (v NullableAeAccountRepresentativeRemovedAms) Get() *AeAccountRepresentativeRemovedAms {
	return v.value
}

func (v *NullableAeAccountRepresentativeRemovedAms) Set(val *AeAccountRepresentativeRemovedAms) {
	v.value = val
	v.isSet = true
}

func (v NullableAeAccountRepresentativeRemovedAms) IsSet() bool {
	return v.isSet
}

func (v *NullableAeAccountRepresentativeRemovedAms) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAeAccountRepresentativeRemovedAms(val *AeAccountRepresentativeRemovedAms) *NullableAeAccountRepresentativeRemovedAms {
	return &NullableAeAccountRepresentativeRemovedAms{value: val, isSet: true}
}

func (v NullableAeAccountRepresentativeRemovedAms) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAeAccountRepresentativeRemovedAms) UnmarshalJSON(src []byte) error {
	v.isSet = true
