...
// checks if the AeAssetSellerChargeAddRequestFailed type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AeAssetSellerChargeAddRequestFailed{}

// AeAssetSellerChargeAddRequestFailed Notification that a service order has been placed
type AeAssetSellerChargeAddRequestFailed struct {
	Detail AeAssetSellerChargeAddRequestFailedDetail `json:"detail"`
...
type _AeAssetSellerChargeAddRequestFailed AeAssetSellerChargeAddRequestFailed
...
func NewAeAssetSellerChargeAddRequestFailed(detail AeAssetSellerChargeAddRequestFailedDetail, detailType string, id string, source string) *AeAssetSellerChargeAddRequestFailed {
	this := AeAssetSellerChargeAddRequestFailed{}
...
func (o *AeAssetSellerChargeAddRequestFailed) GetDetail() AeAssetSellerChargeAddRequestFailedDetail {
	if o == nil {
		var ret AeAssetSellerChargeAddRequestFailedDetail
		return ret
	}
...
func (o AeAssetSellerChargeAddRequestFailed) MarshalJSON() ([]byte, error) {
...
func (o AeAssetSellerChargeAddRequestFailed) ToMap() (map[string]interface{}, error) {
...
func (o *AeAssetSellerChargeAddRequestFailed) UnmarshalJSON(data []byte) (err error) {
	...
	varAeAssetSellerChargeAddRequestFailed := _AeAssetSellerChargeAddRequestFailed{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAeAssetSellerChargeAddRequestFailed)

	if err != nil {
		return err
	}

	*o = AeAssetSellerChargeAddRequestFailed(varAeAssetSellerChargeAddRequestFailed)

	return err
}

type NullableAeAssetSellerChargeAddRequestFailed struct {
	value *AeAssetSellerChargeAddRequestFailed
	isSet bool
}

func (v NullableAeAssetSellerChargeAddRequestFailed) Get() *AeAssetSellerChargeAddRequestFailed {
	return v.value
}

func (v *NullableAeAssetSellerChargeAddRequestFailed) Set(val *AeAssetSellerChargeAddRequestFailed) {
	v.value = val
	v.isSet = true
}

func (v NullableAeAssetSellerChargeAddRequestFailed) IsSet() bool {
	return v.isSet
}

func (v *NullableAeAssetSellerChargeAddRequestFailed) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAeAssetSellerChargeAddRequestFailed(val *AeAssetSellerChargeAddRequestFailed) *NullableAeAssetSellerChargeAddRequestFailed {
	return &NullableAeAssetSellerChargeAddRequestFailed{value: val, isSet: true}
}

func (v NullableAeAssetSellerChargeAddRequestFailed) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAeAssetSellerChargeAddRequestFailed) UnmarshalJSON(src []byte) error {
	v.isSet = true
