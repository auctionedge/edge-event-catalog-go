...
// checks if the AeAssetNotSold type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AeAssetNotSold{}

// AeAssetNotSold Notification that a service order has been placed
type AeAssetNotSold struct {
	Detail AeAssetNotSoldDetail `json:"detail"`
...
type _AeAssetNotSold AeAssetNotSold
...
func (o AeAssetNotSold) MarshalJSON() ([]byte, error) {
...
func (o AeAssetNotSold) ToMap() (map[string]interface{}, error) {
...
func (o *AeAssetNotSold) UnmarshalJSON(data []byte) (err error) {
	...
	varAeAssetNotSold := _AeAssetNotSold{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAeAssetNotSold)

	if err != nil {
		return err
	}

	*o = AeAssetNotSold(varAeAssetNotSold)

	return err
}

type NullableAeAssetNotSold struct {
	value *AeAssetNotSold
	isSet bool
}

func (v NullableAeAssetNotSold) Get() *AeAssetNotSold {
	return v.value
}

func (v *NullableAeAssetNotSold) Set(val *AeAssetNotSold) {
	v.value = val
	v.isSet = true
}

func (v NullableAeAssetNotSold) IsSet() bool {
	return v.isSet
}

func (v *NullableAeAssetNotSold) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAeAssetNotSold(val *AeAssetNotSold) *NullableAeAssetNotSold {
	return &NullableAeAssetNotSold{value: val, isSet: true}
}

func (v NullableAeAssetNotSold) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAeAssetNotSold) UnmarshalJSON(src []byte) error {
	v.isSet = true
