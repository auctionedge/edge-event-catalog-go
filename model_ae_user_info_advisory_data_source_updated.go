...
// checks if the AeUserInfoAdvisoryDataSourceUpdated type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AeUserInfoAdvisoryDataSourceUpdated{}

// AeUserInfoAdvisoryDataSourceUpdated Notification that a service order has been placed
type AeUserInfoAdvisoryDataSourceUpdated struct {
	Detail AeUserInfoAdvisoryDataSourceUpdatedDetail `json:"detail"`
...
type _AeUserInfoAdvisoryDataSourceUpdated AeUserInfoAdvisoryDataSourceUpdated
...
func NewAeUserInfoAdvisoryDataSourceUpdated(detail AeUserInfoAdvisoryDataSourceUpdatedDetail, detailType string, id string, source string) *AeUserInfoAdvisoryDataSourceUpdated {
	this := AeUserInfoAdvisoryDataSourceUpdated{}
...
func (o *AeUserInfoAdvisoryDataSourceUpdated) GetDetail() AeUserInfoAdvisoryDataSourceUpdatedDetail {
	if o == nil {
		var ret AeUserInfoAdvisoryDataSourceUpdatedDetail
		return ret
	}
...
func (o AeUserInfoAdvisoryDataSourceUpdated) MarshalJSON() ([]byte, error) {
...
func (o AeUserInfoAdvisoryDataSourceUpdated) ToMap() (map[string]interface{}, error) {
...
func (o *AeUserInfoAdvisoryDataSourceUpdated) UnmarshalJSON(data []byte) (err error) {
	...
	varAeUserInfoAdvisoryDataSourceUpdated := _AeUserInfoAdvisoryDataSourceUpdated{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAeUserInfoAdvisoryDataSourceUpdated)

	if err != nil {
		return err
	}

	*o = AeUserInfoAdvisoryDataSourceUpdated(varAeUserInfoAdvisoryDataSourceUpdated)

	return err
}

type NullableAeUserInfoAdvisoryDataSourceUpdated struct {
	value *AeUserInfoAdvisoryDataSourceUpdated
	isSet bool
}

func (v NullableAeUserInfoAdvisoryDataSourceUpdated) Get() *AeUserInfoAdvisoryDataSourceUpdated {
	return v.value
}

func (v *NullableAeUserInfoAdvisoryDataSourceUpdated) Set(val *AeUserInfoAdvisoryDataSourceUpdated) {
	v.value = val
	v.isSet = true
}

func (v NullableAeUserInfoAdvisoryDataSourceUpdated) IsSet() bool {
	return v.isSet
}

func (v *NullableAeUserInfoAdvisoryDataSourceUpdated) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAeUserInfoAdvisoryDataSourceUpdated(val *AeUserInfoAdvisoryDataSourceUpdated) *NullableAeUserInfoAdvisoryDataSourceUpdated {
	return &NullableAeUserInfoAdvisoryDataSourceUpdated{value: val, isSet: true}
}

func (v NullableAeUserInfoAdvisoryDataSourceUpdated) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAeUserInfoAdvisoryDataSourceUpdated) UnmarshalJSON(src []byte) error {
	v.isSet = true
