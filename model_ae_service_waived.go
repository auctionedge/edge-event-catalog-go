...
// checks if the AeServiceWaived type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AeServiceWaived{}

// AeServiceWaived Notification that a service order has been placed
type AeServiceWaived struct {
	Detail AeServiceWaivedDetail `json:"detail"`
	// Optional version
...
type _AeServiceWaived AeServiceWaived
...
func (o AeServiceWaived) MarshalJSON() ([]byte, error) {
...
func (o AeServiceWaived) ToMap() (map[string]interface{}, error) {
...
func (o *AeServiceWaived) UnmarshalJSON(data []byte) (err error) {
	...
	varAeServiceWaived := _AeServiceWaived{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAeServiceWaived)

	if err != nil {
		return err
	}

	*o = AeServiceWaived(varAeServiceWaived)

	return err
}

type NullableAeServiceWaived struct {
	value *AeServiceWaived
	isSet bool
}

func (v NullableAeServiceWaived) Get() *AeServiceWaived {
	return v.value
}

func (v *NullableAeServiceWaived) Set(val *AeServiceWaived) {
	v.value = val
	v.isSet = true
}

func (v NullableAeServiceWaived) IsSet() bool {
	return v.isSet
}

func (v *NullableAeServiceWaived) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAeServiceWaived(val *AeServiceWaived) *NullableAeServiceWaived {
	return &NullableAeServiceWaived{value: val, isSet: true}
}

func (v NullableAeServiceWaived) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAeServiceWaived) UnmarshalJSON(src []byte) error {
	v.isSet = true
