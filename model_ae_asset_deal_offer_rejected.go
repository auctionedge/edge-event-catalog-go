...
// checks if the AeAssetDealOfferRejected type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AeAssetDealOfferRejected{}

// AeAssetDealOfferRejected Notification that a service order has been placed
type AeAssetDealOfferRejected struct {
	Detail AeAssetDealOfferRejectedDetail `json:"detail"`
	// Optional version
...
type _AeAssetDealOfferRejected AeAssetDealOfferRejected
...
func (o *AeAssetDealOfferRejected) GetDetail() AeAssetDealOfferRejectedDetail {
	if o == nil {
		var ret AeAssetDealOfferRejectedDetail
		return ret
	}
...
func (o AeAssetDealOfferRejected) MarshalJSON() ([]byte, error) {
...
func (o AeAssetDealOfferRejected) ToMap() (map[string]interface{}, error) {
...
func (o *AeAssetDealOfferRejected) UnmarshalJSON(data []byte) (err error) {
	...
	varAeAssetDealOfferRejected := _AeAssetDealOfferRejected{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAeAssetDealOfferRejected)

	if err != nil {
		return err
	}

	*o = AeAssetDealOfferRejected(varAeAssetDealOfferRejected)

	return err
}

type NullableAeAssetDealOfferRejected struct {
	value *AeAssetDealOfferRejected
	isSet bool
}

func (v NullableAeAssetDealOfferRejected) Get() *AeAssetDealOfferRejected {
	return v.value
}

func (v *NullableAeAssetDealOfferRejected) Set(val *AeAssetDealOfferRejected) {
	v.value = val
	v.isSet = true
}

func (v NullableAeAssetDealOfferRejected) IsSet() bool {
	return v.isSet
}

func (v *NullableAeAssetDealOfferRejected) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAeAssetDealOfferRejected(val *AeAssetDealOfferRejected) *NullableAeAssetDealOfferRejected {
	return &NullableAeAssetDealOfferRejected{value: val, isSet: true}
}

func (v NullableAeAssetDealOfferRejected) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAeAssetDealOfferRejected) UnmarshalJSON(src []byte) error {
	v.isSet = true
