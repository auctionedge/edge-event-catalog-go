...
// checks if the AeAssetDealOfferAccepted type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AeAssetDealOfferAccepted{}

// AeAssetDealOfferAccepted Notification that a service order has been placed
type AeAssetDealOfferAccepted struct {
	Detail AeAssetDealOfferAcceptedDetail `json:"detail"`
...
type _AeAssetDealOfferAccepted AeAssetDealOfferAccepted
...
func (o *AeAssetDealOfferAccepted) GetDetail() AeAssetDealOfferAcceptedDetail {
	if o == nil {
		var ret AeAssetDealOfferAcceptedDetail
		return ret
	}
...
func (o AeAssetDealOfferAccepted) MarshalJSON() ([]byte, error) {
...
func (o AeAssetDealOfferAccepted) ToMap() (map[string]interface{}, error) {
...
func (o *AeAssetDealOfferAccepted) UnmarshalJSON(data []byte) (err error) {
	...
	varAeAssetDealOfferAccepted := _AeAssetDealOfferAccepted{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAeAssetDealOfferAccepted)

	if err != nil {
		return err
	}

	*o = AeAssetDealOfferAccepted(varAeAssetDealOfferAccepted)

	return err
}

type NullableAeAssetDealOfferAccepted struct {
	value *AeAssetDealOfferAccepted
	isSet bool
}

func (v NullableAeAssetDealOfferAccepted) Get() *AeAssetDealOfferAccepted {
	return v.value
}

func (v *NullableAeAssetDealOfferAccepted) Set(val *AeAssetDealOfferAccepted) {
	v.value = val
	v.isSet = true
}

func (v NullableAeAssetDealOfferAccepted) IsSet() bool {
	return v.isSet
}

func (v *NullableAeAssetDealOfferAccepted) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAeAssetDealOfferAccepted(val *AeAssetDealOfferAccepted) *NullableAeAssetDealOfferAccepted {
	return &NullableAeAssetDealOfferAccepted{value: val, isSet: true}
}

func (v NullableAeAssetDealOfferAccepted) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAeAssetDealOfferAccepted) UnmarshalJSON(src []byte) error {
	v.isSet = true
