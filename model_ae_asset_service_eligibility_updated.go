...
// checks if the AeAssetServiceEligibilityUpdated type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AeAssetServiceEligibilityUpdated{}

// AeAssetServiceEligibilityUpdated Notification that a service order has been placed
type AeAssetServiceEligibilityUpdated struct {
	Detail AeAssetServiceEligibilityUpdatedDetail `json:"detail"`
...
type _AeAssetServiceEligibilityUpdated AeAssetServiceEligibilityUpdated
...
func NewAeAssetServiceEligibilityUpdated(detail AeAssetServiceEligibilityUpdatedDetail, detailType string, id string, source string) *AeAssetServiceEligibilityUpdated {
	this := AeAssetServiceEligibilityUpdated{}
...
func (o *AeAssetServiceEligibilityUpdated) GetDetail() AeAssetServiceEligibilityUpdatedDetail {
	if o == nil {
		var ret AeAssetServiceEligibilityUpdatedDetail
		return ret
	}
...
func (o AeAssetServiceEligibilityUpdated) MarshalJSON() ([]byte, error) {
...
func (o AeAssetServiceEligibilityUpdated) ToMap() (map[string]interface{}, error) {
...
func (o *AeAssetServiceEligibilityUpdated) UnmarshalJSON(data []byte) (err error) {
	...
	varAeAssetServiceEligibilityUpdated := _AeAssetServiceEligibilityUpdated{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAeAssetServiceEligibilityUpdated)

	if err != nil {
		return err
	}

	*o = AeAssetServiceEligibilityUpdated(varAeAssetServiceEligibilityUpdated)

	return err
}

type NullableAeAssetServiceEligibilityUpdated struct {
	value *AeAssetServiceEligibilityUpdated
	isSet bool
}

func (v NullableAeAssetServiceEligibilityUpdated) Get() *AeAssetServiceEligibilityUpdated {
	return v.value
}

func (v *NullableAeAssetServiceEligibilityUpdated) Set(val *AeAssetServiceEligibilityUpdated) {
	v.value = val
	v.isSet = true
}

func (v NullableAeAssetServiceEligibilityUpdated) IsSet() bool {
	return v.isSet
}

func (v *NullableAeAssetServiceEligibilityUpdated) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAeAssetServiceEligibilityUpdated(val *AeAssetServiceEligibilityUpdated) *NullableAeAssetServiceEligibilityUpdated {
	return &NullableAeAssetServiceEligibilityUpdated{value: val, isSet: true}
}

func (v NullableAeAssetServiceEligibilityUpdated) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAeAssetServiceEligibilityUpdated) UnmarshalJSON(src []byte) error {
	v.isSet = true
