...
// checks if the AeServiceCompleted type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AeServiceCompleted{}

// AeServiceCompleted Notification that a service order has been placed
type AeServiceCompleted struct {
	Detail AeServiceCompletedDetail `json:"detail"`
...
type _AeServiceCompleted AeServiceCompleted
...
func (o *AeServiceCompleted) GetDetail() AeServiceCompletedDetail {
	if o == nil {
		var ret AeServiceCompletedDetail
		return ret
	}
...
func (o AeServiceCompleted) MarshalJSON() ([]byte, error) {
...
func (o AeServiceCompleted) ToMap() (map[string]interface{}, error) {
...
func (o *AeServiceCompleted) UnmarshalJSON(data []byte) (err error) {
	...
	varAeServiceCompleted := _AeServiceCompleted{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAeServiceCompleted)

	if err != nil {
		return err
	}

	*o = AeServiceCompleted(varAeServiceCompleted)

	return err
}

type NullableAeServiceCompleted struct {
	value *AeServiceCompleted
	isSet bool
}

func (v NullableAeServiceCompleted) Get() *AeServiceCompleted {
	return v.value
}

func (v *NullableAeServiceCompleted) Set(val *AeServiceCompleted) {
	v.value = val
	v.isSet = true
}

func (v NullableAeServiceCompleted) IsSet() bool {
	return v.isSet
}

func (v *NullableAeServiceCompleted) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAeServiceCompleted(val *AeServiceCompleted) *NullableAeServiceCompleted {
	return &NullableAeServiceCompleted{value: val, isSet: true}
}

func (v NullableAeServiceCompleted) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAeServiceCompleted) UnmarshalJSON(src []byte) error {
	v.isSet = true
