...
// checks if the AeServiceOrdered type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AeServiceOrdered{}

// AeServiceOrdered Notification that a service order has been placed
type AeServiceOrdered struct {
	Detail AeServiceOrderedDetail `json:"detail"`
...
type _AeServiceOrdered AeServiceOrdered
...
func (o *AeServiceOrdered) GetDetail() AeServiceOrderedDetail {
	if o == nil {
		var ret AeServiceOrderedDetail
		return ret
	}
...
func (o AeServiceOrdered) MarshalJSON() ([]byte, error) {
...
func (o AeServiceOrdered) ToMap() (map[string]interface{}, error) {
...
func (o *AeServiceOrdered) UnmarshalJSON(data []byte) (err error) {
	...
	varAeServiceOrdered := _AeServiceOrdered{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAeServiceOrdered)

	if err != nil {
		return err
	}

	*o = AeServiceOrdered(varAeServiceOrdered)

	return err
}

type NullableAeServiceOrdered struct {
	value *AeServiceOrdered
	isSet bool
}

func (v NullableAeServiceOrdered) Get() *AeServiceOrdered {
	return v.value
}

func (v *NullableAeServiceOrdered) Set(val *AeServiceOrdered) {
	v.value = val
	v.isSet = true
}

func (v NullableAeServiceOrdered) IsSet() bool {
	return v.isSet
}

func (v *NullableAeServiceOrdered) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAeServiceOrdered(val *AeServiceOrdered) *NullableAeServiceOrdered {
	return &NullableAeServiceOrdered{value: val, isSet: true}
}

func (v NullableAeServiceOrdered) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAeServiceOrdered) UnmarshalJSON(src []byte) error {
	v.isSet = true
