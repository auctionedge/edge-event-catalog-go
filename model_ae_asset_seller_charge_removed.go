...
// checks if the AeAssetSellerChargeRemoved type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AeAssetSellerChargeRemoved{}

// AeAssetSellerChargeRemoved Notification that a service order has been placed
type AeAssetSellerChargeRemoved struct {
	Detail AeAssetSellerChargeRemovedDetail `json:"detail"`
	// Optional version
...
type _AeAssetSellerChargeRemoved AeAssetSellerChargeRemoved
...
func NewAeAssetSellerChargeRemoved(detail AeAssetSellerChargeRemovedDetail, detailType string, id string, source string) *AeAssetSellerChargeRemoved {
	this := AeAssetSellerChargeRemoved{}
...
func (o *AeAssetSellerChargeRemoved) GetDetail() AeAssetSellerChargeRemovedDetail {
	if o == nil {
		var ret AeAssetSellerChargeRemovedDetail
		return ret
	}
...
func (o AeAssetSellerChargeRemoved) MarshalJSON() ([]byte, error) {
...
func (o AeAssetSellerChargeRemoved) ToMap() (map[string]interface{}, error) {
...
func (o *AeAssetSellerChargeRemoved) UnmarshalJSON(data []byte) (err error) {
	...
	varAeAssetSellerChargeRemoved := _AeAssetSellerChargeRemoved{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAeAssetSellerChargeRemoved)

	if err != nil {
		return err
	}

	*o = AeAssetSellerChargeRemoved(varAeAssetSellerChargeRemoved)

	return err
}

type NullableAeAssetSellerChargeRemoved struct {
	value *AeAssetSellerChargeRemoved
	isSet bool
}

func (v NullableAeAssetSellerChargeRemoved) Get() *AeAssetSellerChargeRemoved {
	return v.value
}

func (v *NullableAeAssetSellerChargeRemoved) Set(val *AeAssetSellerChargeRemoved) {
	v.value = val
	v.isSet = true
}

func (v NullableAeAssetSellerChargeRemoved) IsSet() bool {
	return v.isSet
}

func (v *NullableAeAssetSellerChargeRemoved) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAeAssetSellerChargeRemoved(val *AeAssetSellerChargeRemoved) *NullableAeAssetSellerChargeRemoved {
	return &NullableAeAssetSellerChargeRemoved{value: val, isSet: true}
}

func (v NullableAeAssetSellerChargeRemoved) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAeAssetSellerChargeRemoved) UnmarshalJSON(src []byte) error {
	v.isSet = true
