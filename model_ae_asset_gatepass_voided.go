...
// checks if the AeAssetGatepassVoided type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AeAssetGatepassVoided{}

// AeAssetGatepassVoided Notification that a service order has been placed
type AeAssetGatepassVoided struct {
	Detail AeAssetGatepassVoidedDetail `json:"detail"`
...
type _AeAssetGatepassVoided AeAssetGatepassVoided
...
func (o *AeAssetGatepassVoided) GetDetail() AeAssetGatepassVoidedDetail {
	if o == nil {
		var ret AeAssetGatepassVoidedDetail
		return ret
	}
...
func (o AeAssetGatepassVoided) MarshalJSON() ([]byte, error) {
...
func (o AeAssetGatepassVoided) ToMap() (map[string]interface{}, error) {
...
func (o *AeAssetGatepassVoided) UnmarshalJSON(data []byte) (err error) {
	...
	varAeAssetGatepassVoided := _AeAssetGatepassVoided{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAeAssetGatepassVoided)

	if err != nil {
		return err
	}

	*o = AeAssetGatepassVoided(varAeAssetGatepassVoided)

	return err
}

type NullableAeAssetGatepassVoided struct {
	value *AeAssetGatepassVoided
	isSet bool
}

func (v NullableAeAssetGatepassVoided) Get() *AeAssetGatepassVoided {
	return v.value
}

func (v *NullableAeAssetGatepassVoided) Set(val *AeAssetGatepassVoided) {
	v.value = val
	v.isSet = true
}

func (v NullableAeAssetGatepassVoided) IsSet() bool {
	return v.isSet
}

func (v *NullableAeAssetGatepassVoided) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAeAssetGatepassVoided(val *AeAssetGatepassVoided) *NullableAeAssetGatepassVoided {
	return &NullableAeAssetGatepassVoided{value: val, isSet: true}
}

func (v NullableAeAssetGatepassVoided) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAeAssetGatepassVoided) UnmarshalJSON(src []byte) error {
	v.isSet = true
