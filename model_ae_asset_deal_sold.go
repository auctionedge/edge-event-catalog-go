...
// checks if the AeAssetDealSold type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AeAssetDealSold{}

// AeAssetDealSold Notification that a service order has been placed
type AeAssetDealSold struct {
	Detail AeAssetDealSoldDetail `json:"detail"`
	// Optional version
...
type _AeAssetDealSold AeAssetDealSold
...
func (o AeAssetDealSold) MarshalJSON() ([]byte, error) {
...
func (o AeAssetDealSold) ToMap() (map[string]interface{}, error) {
...
func (o *AeAssetDealSold) UnmarshalJSON(data []byte) (err error) {
	...
	varAeAssetDealSold := _AeAssetDealSold{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAeAssetDealSold)

	if err != nil {
		return err
	}

	*o = AeAssetDealSold(varAeAssetDealSold)

	return err
}

type NullableAeAssetDealSold struct {
	value *AeAssetDealSold
	isSet bool
}

func (v NullableAeAssetDealSold) Get() *AeAssetDealSold {
	return v.value
}

func (v *NullableAeAssetDealSold) Set(val *AeAssetDealSold) {
	v.value = val
	v.isSet = true
}

func (v NullableAeAssetDealSold) IsSet() bool {
	return v.isSet
}

func (v *NullableAeAssetDealSold) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAeAssetDealSold(val *AeAssetDealSold) *NullableAeAssetDealSold {
	return &NullableAeAssetDealSold{value: val, isSet: true}
}

func (v NullableAeAssetDealSold) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAeAssetDealSold) UnmarshalJSON(src []byte) error {
	v.isSet = true
