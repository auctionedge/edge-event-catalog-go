...
// checks if the AeAssetSellerChargeAddRequested type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AeAssetSellerChargeAddRequested{}

// AeAssetSellerChargeAddRequested Notification that a service order has been placed
type AeAssetSellerChargeAddRequested struct {
	Detail AeAssetSellerChargeAddRequestedDetail `json:"detail"`
...
type _AeAssetSellerChargeAddRequested AeAssetSellerChargeAddRequested
...
func NewAeAssetSellerChargeAddRequested(detail AeAssetSellerChargeAddRequestedDetail, detailType string, id string, source string) *AeAssetSellerChargeAddRequested {
	this := AeAssetSellerChargeAddRequested{}
...
func (o *AeAssetSellerChargeAddRequested) GetDetail() AeAssetSellerChargeAddRequestedDetail {
	if o == nil {
		var ret AeAssetSellerChargeAddRequestedDetail
		return ret
	}
...
func (o AeAssetSellerChargeAddRequested) MarshalJSON() ([]byte, error) {
...
func (o AeAssetSellerChargeAddRequested) ToMap() (map[string]interface{}, error) {
...
func (o *AeAssetSellerChargeAddRequested) UnmarshalJSON(data []byte) (err error) {
	...
	varAeAssetSellerChargeAddRequested := _AeAssetSellerChargeAddRequested{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAeAssetSellerChargeAddRequested)

	if err != nil {
		return err
	}

	*o = AeAssetSellerChargeAddRequested(varAeAssetSellerChargeAddRequested)

	return err
}

type NullableAeAssetSellerChargeAddRequested struct {
	value *AeAssetSellerChargeAddRequested
	isSet bool
}

func (v NullableAeAssetSellerChargeAddRequested) Get() *AeAssetSellerChargeAddRequested {
	return v.value
}

func (v *NullableAeAssetSellerChargeAddRequested) Set(val *AeAssetSellerChargeAddRequested) {
	v.value = val
	v.isSet = true
}

func (v NullableAeAssetSellerChargeAddRequested) IsSet() bool {
	return v.isSet
}

func (v *NullableAeAssetSellerChargeAddRequested) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAeAssetSellerChargeAddRequested(val *AeAssetSellerChargeAddRequested) *NullableAeAssetSellerChargeAddRequested {
	return &NullableAeAssetSellerChargeAddRequested{value: val, isSet: true}
}

func (v NullableAeAssetSellerChargeAddRequested) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAeAssetSellerChargeAddRequested) UnmarshalJSON(src []byte) error {
	v.isSet = true
