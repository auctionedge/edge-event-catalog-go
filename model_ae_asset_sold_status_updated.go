...
// checks if the AeAssetSoldStatusUpdated type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AeAssetSoldStatusUpdated{}

// AeAssetSoldStatusUpdated Notification that a service order has been placed
type AeAssetSoldStatusUpdated struct {
	Detail AeAssetSoldStatusUpdatedDetail `json:"detail"`
...
type _AeAssetSoldStatusUpdated AeAssetSoldStatusUpdated
...
func (o *AeAssetSoldStatusUpdated) GetDetail() AeAssetSoldStatusUpdatedDetail {
	if o == nil {
		var ret AeAssetSoldStatusUpdatedDetail
		return ret
	}
...
func (o AeAssetSoldStatusUpdated) MarshalJSON() ([]byte, error) {
...
func (o AeAssetSoldStatusUpdated) ToMap() (map[string]interface{}, error) {
...
func (o *AeAssetSoldStatusUpdated) UnmarshalJSON(data []byte) (err error) {
	...
	varAeAssetSoldStatusUpdated := _AeAssetSoldStatusUpdated{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAeAssetSoldStatusUpdated)

	if err != nil {
		return err
	}

	*o = AeAssetSoldStatusUpdated(varAeAssetSoldStatusUpdated)

	return err
}

type NullableAeAssetSoldStatusUpdated struct {
	value *AeAssetSoldStatusUpdated
	isSet bool
}

func (v NullableAeAssetSoldStatusUpdated) Get() *AeAssetSoldStatusUpdated {
	return v.value
}

func (v *NullableAeAssetSoldStatusUpdated) Set(val *AeAssetSoldStatusUpdated) {
	v.value = val
	v.isSet = true
}

func (v NullableAeAssetSoldStatusUpdated) IsSet() bool {
	return v.isSet
}

func (v *NullableAeAssetSoldStatusUpdated) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAeAssetSoldStatusUpdated(val *AeAssetSoldStatusUpdated) *NullableAeAssetSoldStatusUpdated {
	return &NullableAeAssetSoldStatusUpdated{value: val, isSet: true}
}

func (v NullableAeAssetSoldStatusUpdated) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAeAssetSoldStatusUpdated) UnmarshalJSON(src []byte) error {
	v.isSet = true
