...
// checks if the AeAssetGatepassDelivered type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AeAssetGatepassDelivered{}

// AeAssetGatepassDelivered Notification that a service order has been placed
type AeAssetGatepassDelivered struct {
	Detail AeAssetGatepassDeliveredDetail `json:"detail"`
	// Optional version
...
type _AeAssetGatepassDelivered AeAssetGatepassDelivered
...
func (o *AeAssetGatepassDelivered) GetDetail() AeAssetGatepassDeliveredDetail {
	if o == nil {
		var ret AeAssetGatepassDeliveredDetail
		return ret
	}
...
func (o AeAssetGatepassDelivered) MarshalJSON() ([]byte, error) {
...
func (o AeAssetGatepassDelivered) ToMap() (map[string]interface{}, error) {
...
func (o *AeAssetGatepassDelivered) UnmarshalJSON(data []byte) (err error) {
	...
	varAeAssetGatepassDelivered := _AeAssetGatepassDelivered{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAeAssetGatepassDelivered)

	if err != nil {
		return err
	}

	*o = AeAssetGatepassDelivered(varAeAssetGatepassDelivered)

	return err
}

type NullableAeAssetGatepassDelivered struct {
	value *AeAssetGatepassDelivered
	isSet bool
}

func (v NullableAeAssetGatepassDelivered) Get() *AeAssetGatepassDelivered {
	return v.value
}

func (v *NullableAeAssetGatepassDelivered) Set(val *AeAssetGatepassDelivered) {
	v.value = val
	v.isSet = true
}

func (v NullableAeAssetGatepassDelivered) IsSet() bool {
	return v.isSet
}

func (v *NullableAeAssetGatepassDelivered) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAeAssetGatepassDelivered(val *AeAssetGatepassDelivered) *NullableAeAssetGatepassDelivered {
	return &NullableAeAssetGatepassDelivered{value: val, isSet: true}
}

func (v NullableAeAssetGatepassDelivered) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAeAssetGatepassDelivered) UnmarshalJSON(src []byte) error {
	v.isSet = true
