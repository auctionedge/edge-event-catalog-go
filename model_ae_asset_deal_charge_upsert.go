...
// checks if the AeAssetDealChargeUpsert type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AeAssetDealChargeUpsert{}

// AeAssetDealChargeUpsert Notification that a service order has been placed
type AeAssetDealChargeUpsert struct {
	Detail AeAssetDealChargeUpsertDetail `json:"detail"`
	// Optional version
...
type _AeAssetDealChargeUpsert AeAssetDealChargeUpsert
...
func (o *AeAssetDealChargeUpsert) GetDetail() AeAssetDealChargeUpsertDetail {
	if o == nil {
		var ret AeAssetDealChargeUpsertDetail
		return ret
	}
...
func (o AeAssetDealChargeUpsert) MarshalJSON() ([]byte, error) {
...
func (o AeAssetDealChargeUpsert) ToMap() (map[string]interface{}, error) {
...
func (o *AeAssetDealChargeUpsert) UnmarshalJSON(data []byte) (err error) {
	...
	varAeAssetDealChargeUpsert := _AeAssetDealChargeUpsert{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAeAssetDealChargeUpsert)

	if err != nil {
		return err
	}

	*o = AeAssetDealChargeUpsert(varAeAssetDealChargeUpsert)

	return err
}

type NullableAeAssetDealChargeUpsert struct {
	value *AeAssetDealChargeUpsert
	isSet bool
}

func (v NullableAeAssetDealChargeUpsert) Get() *AeAssetDealChargeUpsert {
	return v.value
}

func (v *NullableAeAssetDealChargeUpsert) Set(val *AeAssetDealChargeUpsert) {
	v.value = val
	v.isSet = true
}

func (v NullableAeAssetDealChargeUpsert) IsSet() bool {
	return v.isSet
}

func (v *NullableAeAssetDealChargeUpsert) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAeAssetDealChargeUpsert(val *AeAssetDealChargeUpsert) *NullableAeAssetDealChargeUpsert {
	return &NullableAeAssetDealChargeUpsert{value: val, isSet: true}
}

func (v NullableAeAssetDealChargeUpsert) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAeAssetDealChargeUpsert) UnmarshalJSON(src []byte) error {
	v.isSet = true
