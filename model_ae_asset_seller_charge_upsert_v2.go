...
// checks if the AeAssetSellerChargeUpsertV2 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AeAssetSellerChargeUpsertV2{}

// AeAssetSellerChargeUpsertV2 Notification that a service order has been placed
type AeAssetSellerChargeUpsertV2 struct {
	Detail AeAssetSellerChargeUpsertV2Detail `json:"detail"`
...
type _AeAssetSellerChargeUpsertV2 AeAssetSellerChargeUpsertV2
...
func NewAeAssetSellerChargeUpsertV2(detail AeAssetSellerChargeUpsertV2Detail, detailType string, id string, source string) *AeAssetSellerChargeUpsertV2 {
	this := AeAssetSellerChargeUpsertV2{}
...
func (o *AeAssetSellerChargeUpsertV2) GetDetail() AeAssetSellerChargeUpsertV2Detail {
	if o == nil {
		var ret AeAssetSellerChargeUpsertV2Detail
		return ret
	}
...
func (o AeAssetSellerChargeUpsertV2) MarshalJSON() ([]byte, error) {
...
func (o AeAssetSellerChargeUpsertV2) ToMap() (map[string]interface{}, error) {
...
func (o *AeAssetSellerChargeUpsertV2) UnmarshalJSON(data []byte) (err error) {
	...
	varAeAssetSellerChargeUpsertV2 := _AeAssetSellerChargeUpsertV2{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAeAssetSellerChargeUpsertV2)

	if err != nil {
		return err
	}

	*o = AeAssetSellerChargeUpsertV2(varAeAssetSellerChargeUpsertV2)

	return err
}

type NullableAeAssetSellerChargeUpsertV2 struct {
	value *AeAssetSellerChargeUpsertV2
	isSet bool
}

func (v NullableAeAssetSellerChargeUpsertV2) Get() *AeAssetSellerChargeUpsertV2 {
	return v.value
}

func (v *NullableAeAssetSellerChargeUpsertV2) Set(val *AeAssetSellerChargeUpsertV2) {
	v.value = val
	v.isSet = true
}

func (v NullableAeAssetSellerChargeUpsertV2) IsSet() bool {
	return v.isSet
}

func (v *NullableAeAssetSellerChargeUpsertV2) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAeAssetSellerChargeUpsertV2(val *AeAssetSellerChargeUpsertV2) *NullableAeAssetSellerChargeUpsertV2 {
	return &NullableAeAssetSellerChargeUpsertV2{value: val, isSet: true}
}

func (v NullableAeAssetSellerChargeUpsertV2) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAeAssetSellerChargeUpsertV2) UnmarshalJSON(src []byte) error {
	v.isSet = true
