...
// checks if the AeAdvisoryAccountAms type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AeAdvisoryAccountAms{}
...
type _AeAdvisoryAccountAms AeAdvisoryAccountAms
...
func (o *AeAdvisoryAccountAms) GetDetail() AeAdvisoryAccountAmsDetail {
	if o == nil {
		var ret AeAdvisoryAccountAmsDetail
		return ret
	}
...
func (o AeAdvisoryAccountAms) MarshalJSON() ([]byte, error) {
...
func (o *AeAdvisoryAccountAms) UnmarshalJSON(data []byte) (err error) {
	...
	varAeAdvisoryAccountAms := _AeAdvisoryAccountAms{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAeAdvisoryAccountAms)

	if err != nil {
		return err
	}

	*o = AeAdvisoryAccountAms(varAeAdvisoryAccountAms)

	return err
}

type NullableAeAdvisoryAccountAms struct {
	value *AeAdvisoryAccountAms
	isSet bool
}

func (v NullableAeAdvisoryAccountAms) Get() *AeAdvisoryAccountAms {
	return v.value
}

func (v *NullableAeAdvisoryAccountAms) Set(val *AeAdvisoryAccountAms) {
	v.value = val
	v.isSet = true
}

func (v NullableAeAdvisoryAccountAms) IsSet() bool {
	return v.isSet
}

func (v *NullableAeAdvisoryAccountAms) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAeAdvisoryAccountAms(val *AeAdvisoryAccountAms) *NullableAeAdvisoryAccountAms {
	return &NullableAeAdvisoryAccountAms{value: val, isSet: true}
}

func (v NullableAeAdvisoryAccountAms) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAeAdvisoryAccountAms) UnmarshalJSON(src []byte) error {
	v.isSet = true
