...
// checks if the AeAdvisoryAccountRepresentativesAms type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AeAdvisoryAccountRepresentativesAms{}

// AeAdvisoryAccountRepresentativesAms Notification that a service order has been placed
type AeAdvisoryAccountRepresentativesAms struct {
	Detail AeAdvisoryAccountRepresentativesAmsDetail `json:"detail"`
...
type _AeAdvisoryAccountRepresentativesAms AeAdvisoryAccountRepresentativesAms
...
func NewAeAdvisoryAccountRepresentativesAms(detail AeAdvisoryAccountRepresentativesAmsDetail, detailType string, id string, source string) *AeAdvisoryAccountRepresentativesAms {
	this := AeAdvisoryAccountRepresentativesAms{}
...
func (o *AeAdvisoryAccountRepresentativesAms) GetDetail() AeAdvisoryAccountRepresentativesAmsDetail {
	if o == nil {
		var ret AeAdvisoryAccountRepresentativesAmsDetail
		return ret
	}
...
func (o AeAdvisoryAccountRepresentativesAms) MarshalJSON() ([]byte, error) {
...
func (o AeAdvisoryAccountRepresentativesAms) ToMap() (map[string]interface{}, error) {
...
func (o *AeAdvisoryAccountRepresentativesAms) UnmarshalJSON(data []byte) (err error) {
	...
	varAeAdvisoryAccountRepresentativesAms := _AeAdvisoryAccountRepresentativesAms{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAeAdvisoryAccountRepresentativesAms)

	if err != nil {
		return err
	}

	*o = AeAdvisoryAccountRepresentativesAms(varAeAdvisoryAccountRepresentativesAms)

	return err
}

type NullableAeAdvisoryAccountRepresentativesAms struct {
	value *AeAdvisoryAccountRepresentativesAms
	isSet bool
}

func (v NullableAeAdvisoryAccountRepresentativesAms) Get() *AeAdvisoryAccountRepresentativesAms {
	return v.value
}

func (v *NullableAeAdvisoryAccountRepresentativesAms) Set(val *AeAdvisoryAccountRepresentativesAms) {
	v.value = val
	v.isSet = true
}

func (v NullableAeAdvisoryAccountRepresentativesAms) IsSet() bool {
	return v.isSet
}

func (v *NullableAeAdvisoryAccountRepresentativesAms) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAeAdvisoryAccountRepresentativesAms(val *AeAdvisoryAccountRepresentativesAms) *NullableAeAdvisoryAccountRepresentativesAms {
	return &NullableAeAdvisoryAccountRepresentativesAms{value: val, isSet: true}
}

func (v NullableAeAdvisoryAccountRepresentativesAms) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAeAdvisoryAccountRepresentativesAms) UnmarshalJSON(src []byte) error {
	v.isSet = true
