...
// checks if the AeAssetPaidStatusUpdated type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AeAssetPaidStatusUpdated{}

// AeAssetPaidStatusUpdated Notification that a service order has been placed
type AeAssetPaidStatusUpdated struct {
	Detail AeAssetPaidStatusUpdatedDetail `json:"detail"`
...
type _AeAssetPaidStatusUpdated AeAssetPaidStatusUpdated
...
func (o *AeAssetPaidStatusUpdated) GetDetail() AeAssetPaidStatusUpdatedDetail {
	if o == nil {
		var ret AeAssetPaidStatusUpdatedDetail
		return ret
	}
...
func (o AeAssetPaidStatusUpdated) MarshalJSON() ([]byte, error) {
...
func (o AeAssetPaidStatusUpdated) ToMap() (map[string]interface{}, error) {
...
func (o *AeAssetPaidStatusUpdated) UnmarshalJSON(data []byte) (err error) {
	...
	varAeAssetPaidStatusUpdated := _AeAssetPaidStatusUpdated{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAeAssetPaidStatusUpdated)

	if err != nil {
		return err
	}

	*o = AeAssetPaidStatusUpdated(varAeAssetPaidStatusUpdated)

	return err
}

type NullableAeAssetPaidStatusUpdated struct {
	value *AeAssetPaidStatusUpdated
	isSet bool
}

func (v NullableAeAssetPaidStatusUpdated) Get() *AeAssetPaidStatusUpdated {
	return v.value
}

func (v *NullableAeAssetPaidStatusUpdated) Set(val *AeAssetPaidStatusUpdated) {
	v.value = val
	v.isSet = true
}

func (v NullableAeAssetPaidStatusUpdated) IsSet() bool {
	return v.isSet
}

func (v *NullableAeAssetPaidStatusUpdated) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAeAssetPaidStatusUpdated(val *AeAssetPaidStatusUpdated) *NullableAeAssetPaidStatusUpdated {
	return &NullableAeAssetPaidStatusUpdated{value: val, isSet: true}
}

func (v NullableAeAssetPaidStatusUpdated) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAeAssetPaidStatusUpdated) UnmarshalJSON(src []byte) error {
	v.isSet = true
