...
// checks if the AeAccountUpsertedAms type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AeAccountUpsertedAms{}

// AeAccountUpsertedAms Notification that a service order has been placed
type AeAccountUpsertedAms struct {
	Detail AeAccountUpsertedAmsDetail `json:"detail"`
...
type _AeAccountUpsertedAms AeAccountUpsertedAms
...
func (o *AeAccountUpsertedAms) GetDetail() AeAccountUpsertedAmsDetail {
	if o == nil {
		var ret AeAccountUpsertedAmsDetail
		return ret
	}
...
func (o AeAccountUpsertedAms) MarshalJSON() ([]byte, error) {
...
func (o AeAccountUpsertedAms) ToMap() (map[string]interface{}, error) {
...
func (o *AeAccountUpsertedAms) UnmarshalJSON(data []byte) (err error) {
	...
	varAeAccountUpsertedAms := _AeAccountUpsertedAms{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAeAccountUpsertedAms)

	if err != nil {
		return err
	}

	*o = AeAccountUpsertedAms(varAeAccountUpsertedAms)

	return err
}

type NullableAeAccountUpsertedAms struct {
	value *AeAccountUpsertedAms
	isSet bool
}

func (v NullableAeAccountUpsertedAms) Get() *AeAccountUpsertedAms {
	return v.value
}

func (v *NullableAeAccountUpsertedAms) Set(val *AeAccountUpsertedAms) {
	v.value = val
	v.isSet = true
}

func (v NullableAeAccountUpsertedAms) IsSet() bool {
	return v.isSet
}

func (v *NullableAeAccountUpsertedAms) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAeAccountUpsertedAms(val *AeAccountUpsertedAms) *NullableAeAccountUpsertedAms {
	return &NullableAeAccountUpsertedAms{value: val, isSet: true}
}

func (v NullableAeAccountUpsertedAms) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAeAccountUpsertedAms) UnmarshalJSON(src []byte) error {
	v.isSet = true
