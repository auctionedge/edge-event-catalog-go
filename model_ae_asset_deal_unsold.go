...
// checks if the AeAssetDealUnsold type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AeAssetDealUnsold{}

// AeAssetDealUnsold Notification that a service order has been placed
type AeAssetDealUnsold struct {
	Detail AeAssetDealUnsoldDetail `json:"detail"`
...
type _AeAssetDealUnsold AeAssetDealUnsold
...
func (o *AeAssetDealUnsold) GetDetail() AeAssetDealUnsoldDetail {
	if o == nil {
		var ret AeAssetDealUnsoldDetail
		return ret
	}
...
func (o AeAssetDealUnsold) MarshalJSON() ([]byte, error) {
...
func (o AeAssetDealUnsold) ToMap() (map[string]interface{}, error) {
...
func (o *AeAssetDealUnsold) UnmarshalJSON(data []byte) (err error) {
	...
	varAeAssetDealUnsold := _AeAssetDealUnsold{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAeAssetDealUnsold)

	if err != nil {
		return err
	}

	*o = AeAssetDealUnsold(varAeAssetDealUnsold)

	return err
}

type NullableAeAssetDealUnsold struct {
	value *AeAssetDealUnsold
	isSet bool
}

func (v NullableAeAssetDealUnsold) Get() *AeAssetDealUnsold {
	return v.value
}

func (v *NullableAeAssetDealUnsold) Set(val *AeAssetDealUnsold) {
	v.value = val
	v.isSet = true
}

func (v NullableAeAssetDealUnsold) IsSet() bool {
	return v.isSet
}

func (v *NullableAeAssetDealUnsold) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAeAssetDealUnsold(val *AeAssetDealUnsold) *NullableAeAssetDealUnsold {
	return &NullableAeAssetDealUnsold{value: val, isSet: true}
}

func (v NullableAeAssetDealUnsold) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAeAssetDealUnsold) UnmarshalJSON(src []byte) error {
	v.isSet = true
