...
// checks if the AeDocumentAssetAdded type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AeDocumentAssetAdded{}

// AeDocumentAssetAdded Notification that a service order has been placed
type AeDocumentAssetAdded struct {
	Detail AeDocumentAssetAddedDetail `json:"detail"`
...
type _AeDocumentAssetAdded AeDocumentAssetAdded
...
func (o *AeDocumentAssetAdded) GetDetail() AeDocumentAssetAddedDetail {
	if o == nil {
		var ret AeDocumentAssetAddedDetail
		return ret
	}
...
func (o AeDocumentAssetAdded) MarshalJSON() ([]byte, error) {
...
func (o AeDocumentAssetAdded) ToMap() (map[string]interface{}, error) {
...
func (o *AeDocumentAssetAdded) UnmarshalJSON(data []byte) (err error) {
	...
	varAeDocumentAssetAdded := _AeDocumentAssetAdded{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAeDocumentAssetAdded)

	if err != nil {
		return err
	}

	*o = AeDocumentAssetAdded(varAeDocumentAssetAdded)

	return err
}

type NullableAeDocumentAssetAdded struct {
	value *AeDocumentAssetAdded
	isSet bool
}

func (v NullableAeDocumentAssetAdded) Get() *AeDocumentAssetAdded {
	return v.value
}

func (v *NullableAeDocumentAssetAdded) Set(val *AeDocumentAssetAdded) {
	v.value = val
	v.isSet = true
}

func (v NullableAeDocumentAssetAdded) IsSet() bool {
	return v.isSet
}

func (v *NullableAeDocumentAssetAdded) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAeDocumentAssetAdded(val *AeDocumentAssetAdded) *NullableAeDocumentAssetAdded {
	return &NullableAeDocumentAssetAdded{value: val, isSet: true}
}

func (v NullableAeDocumentAssetAdded) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAeDocumentAssetAdded) UnmarshalJSON(src []byte) error {
	v.isSet = true
