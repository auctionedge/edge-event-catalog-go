...
// checks if the AeAdvisoryRequestAccountAms type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AeAdvisoryRequestAccountAms{}

// AeAdvisoryRequestAccountAms Notification that a service order has been placed
type AeAdvisoryRequestAccountAms struct {
	Detail AeAdvisoryRequestAccountAmsDetail `json:"detail"`
...
type _AeAdvisoryRequestAccountAms AeAdvisoryRequestAccountAms
...
func NewAeAdvisoryRequestAccountAms(detail AeAdvisoryRequestAccountAmsDetail, detailType string, id string, source string) *AeAdvisoryRequestAccountAms {
	this := AeAdvisoryRequestAccountAms{}
...
func (o *AeAdvisoryRequestAccountAms) GetDetail() AeAdvisoryRequestAccountAmsDetail {
	if o == nil {
		var ret AeAdvisoryRequestAccountAmsDetail
		return ret
	}
...
func (o AeAdvisoryRequestAccountAms) MarshalJSON() ([]byte, error) {
...
func (o AeAdvisoryRequestAccountAms) ToMap() (map[string]interface{}, error) {
...
func (o *AeAdvisoryRequestAccountAms) UnmarshalJSON(data []byte) (err error) {
	...
	varAeAdvisoryRequestAccountAms := _AeAdvisoryRequestAccountAms{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAeAdvisoryRequestAccountAms)

	if err != nil {
		return err
	}

	*o = AeAdvisoryRequestAccountAms(varAeAdvisoryRequestAccountAms)

	return err
}

type NullableAeAdvisoryRequestAccountAms struct {
	value *AeAdvisoryRequestAccountAms
	isSet bool
}

func (v NullableAeAdvisoryRequestAccountAms) Get() *AeAdvisoryRequestAccountAms {
	return v.value
}

func (v *NullableAeAdvisoryRequestAccountAms) Set(val *AeAdvisoryRequestAccountAms) {
	v.value = val
	v.isSet = true
}

func (v NullableAeAdvisoryRequestAccountAms) IsSet() bool {
	return v.isSet
}

func (v *NullableAeAdvisoryRequestAccountAms) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAeAdvisoryRequestAccountAms(val *AeAdvisoryRequestAccountAms) *NullableAeAdvisoryRequestAccountAms {
	return &NullableAeAdvisoryRequestAccountAms{value: val, isSet: true}
}

func (v NullableAeAdvisoryRequestAccountAms) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAeAdvisoryRequestAccountAms) UnmarshalJSON(src []byte) error {
	v.isSet = true
