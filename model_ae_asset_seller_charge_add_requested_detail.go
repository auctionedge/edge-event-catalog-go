...
// checks if the AeAssetSellerChargeAddRequestedDetail type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AeAssetSellerChargeAddRequestedDetail{}

// AeAssetSellerChargeAddRequestedDetail A request for a charge to be added to an asset for a seller.
type AeAssetSellerChargeAddRequestedDetail struct {
	...
	Charge AeAssetSellerChargeAddRequestedDetailCharge `json:"charge"`
	Initiator *CommonInitiator `json:"initiator,omitempty"`
}

type _AeAssetSellerChargeAddRequestedDetail AeAssetSellerChargeAddRequestedDetail
...
func NewAeAssetSellerChargeAddRequestedDetail(auctionId string, assetId string, vin string, stock string, seller CommonAmsAccountPointer, referenceId string, charge AeAssetSellerChargeAddRequestedDetailCharge) *AeAssetSellerChargeAddRequestedDetail {
	this := AeAssetSellerChargeAddRequestedDetail{}
...
func (o *AeAssetSellerChargeAddRequestedDetail) GetCharge() AeAssetSellerChargeAddRequestedDetailCharge {
	if o == nil {
		var ret AeAssetSellerChargeAddRequestedDetailCharge
		return ret
	}
...
func (o AeAssetSellerChargeAddRequestedDetail) MarshalJSON() ([]byte, error) {
...
func (o AeAssetSellerChargeAddRequestedDetail) ToMap() (map[string]interface{}, error) {
...
func (o *AeAssetSellerChargeAddRequestedDetail) UnmarshalJSON(data []byte) (err error) {
	...
	varAeAssetSellerChargeAddRequestedDetail := _AeAssetSellerChargeAddRequestedDetail{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAeAssetSellerChargeAddRequestedDetail)

	if err != nil {
		return err
	}

	*o = AeAssetSellerChargeAddRequestedDetail(varAeAssetSellerChargeAddRequestedDetail)

	return err
}

type NullableAeAssetSellerChargeAddRequestedDetail struct {
	value *AeAssetSellerChargeAddRequestedDetail
	isSet bool
}

func (v NullableAeAssetSellerChargeAddRequestedDetail) Get() *AeAssetSellerChargeAddRequestedDetail {
	return v.value
}

func (v *NullableAeAssetSellerChargeAddRequestedDetail) Set(val *AeAssetSellerChargeAddRequestedDetail) {
	v.value = val
	v.isSet = true
}

func (v NullableAeAssetSellerChargeAddRequestedDetail) IsSet() bool {
	return v.isSet
}

func (v *NullableAeAssetSellerChargeAddRequestedDetail) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAeAssetSellerChargeAddRequestedDetail(val *AeAssetSellerChargeAddRequestedDetail) *NullableAeAssetSellerChargeAddRequestedDetail {
	return &NullableAeAssetSellerChargeAddRequestedDetail{value: val, isSet: true}
}

func (v NullableAeAssetSellerChargeAddRequestedDetail) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAeAssetSellerChargeAddRequestedDetail) UnmarshalJSON(src []byte) error {
	v.isSet = true
