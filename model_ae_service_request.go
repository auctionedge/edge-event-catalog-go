...
// checks if the AeServiceRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AeServiceRequest{}

// AeServiceRequest Notification that a service order has been placed
type AeServiceRequest struct {
	Detail AeServiceRequestDetail `json:"detail"`
...
type _AeServiceRequest AeServiceRequest
...
func (o *AeServiceRequest) GetDetail() AeServiceRequestDetail {
	if o == nil {
		var ret AeServiceRequestDetail
		return ret
	}
...
func (o AeServiceRequest) MarshalJSON() ([]byte, error) {
...
func (o AeServiceRequest) ToMap() (map[string]interface{}, error) {
...
func (o *AeServiceRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varAeServiceRequest := _AeServiceRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAeServiceRequest)

	if err != nil {
		return err
	}

	*o = AeServiceRequest(varAeServiceRequest)

	return err
}

type NullableAeServiceRequest struct {
	value *AeServiceRequest
	isSet bool
}

func (v NullableAeServiceRequest) Get() *AeServiceRequest {
	return v.value
}

func (v *NullableAeServiceRequest) Set(val *AeServiceRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableAeServiceRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableAeServiceRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAeServiceRequest(val *AeServiceRequest) *NullableAeServiceRequest {
	return &NullableAeServiceRequest{value: val, isSet: true}
}

func (v NullableAeServiceRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAeServiceRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
